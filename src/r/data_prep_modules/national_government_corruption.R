# Harmonize national government corruption perception variable
...
cat("\n=== NATIONAL GOVERNMENT CORRUPTION HARMONIZATION ===\n")
...
yaml_path <- here::here("src", "config", "harmonize", "national_government_corruption.yml")
...
output_path <- here::here("data", "processed", "national_government_corruption_harmonized.rds")
