...
Survey data (Waves 2, 3, 4, and 6; N ≈ 1,000--1,242 per wave),
supplemented by the 2017 Cambodia Socio-Economic Survey (N = 3,363),
this article traces the arc of that transformation as a sequential
process: from post-conflict acquiescence, through a remarkable peak of
democratic aspiration and civic mobilization, to a final condition of
political withdrawal and regime normalization following the elimination
of organized opposition. The Cambodian case offers an unusually clean
...
subtraction}. The forced dissolution of the Cambodia National Rescue
Party in 2017 was the keystone of a broader campaign of political
closure---encompassing independent media shutdowns, civil society
restrictions, and an uncontested national election---that collectively
restructured citizen orientations across multiple attitudinal and
behavioral dimensions simultaneously. The article documents a
theoretically consequential divergence: abstract democratic
commitment---the belief that democracy is the best form of
government---remained largely intact across the study period, while
democratic prioritization, feasibility expectations, and independent
civic engagement collapsed in parallel. Citizens did not abandon
democratic ideals; they ceased to believe those ideals were achievable
and ceased to prioritize them against competing goods. The findings
challenge accounts that treat authoritarian legitimacy as a product of
performance or ideology, suggesting instead that the most effective
mechanism of regime stabilization may be the systematic closure of the
...
collective action. The combined effect restructured the political field
so thoroughly that Cambodian citizens adjusted their attitudes,
behaviors, and expectations in a remarkably coherent pattern. This
article argues that this adjustment is best understood not as a story of
authoritarian consolidation in the conventional sense---not as the
triumph of ideology, coercion, or performance legitimacy---but as
something quieter and, in its way, more profound: the education of a
citizenry in the limits of the politically possible.
...
that opposition elimination---understood not as a single act but as the
systematic dismantling of the political alternative and the
institutional ecosystem that sustained it---produces a distinctive
observable signature in public opinion: synchronized, multi-domain
shifts in which democratic expectations, independent civic engagement,
political attention, and willingness to report corruption all decline in
parallel, while acceptance of authoritarian governance alternatives and
participation through regime-managed channels rise. The critical
diagnostic indicator is a divergence between electoral and civic
participation---rising voter turnout amid collapsing independent
engagement---that signals the transformation of elections from
mechanisms of political choice into rituals of regime compliance. If
this signature proves generalizable beyond the Cambodian case, it offers
both a theoretical framework for understanding how authoritarian regimes
stabilize through subtraction rather than through active legitimation,
and a practical diagnostic tool for identifying democratic closure in
real time using existing cross-national survey infrastructure.
...
co-optation.\footnote{For the foundational typologies of these
  institutional survival mechanics, see Levitsky and A. (2010); Schedler
...
In practice, subtraction rarely occurs as a single surgical act; the
Cambodian case involved the coordinated elimination of the opposition
party, independent media outlets, and civil society infrastructure
within a compressed period. The theoretical claim is that the decisive
mechanism is the closure of the political field---the elimination of the
vehicle for collective political expression---rather than the fear,
material deprivation, or ideological conversion that characterize
repression and co-optation respectively. The result is not fear-based
withdrawal or interest-based compliance but something closer to what
Gaventa termed ``quiescence''---the internalization of powerlessness
that follows from the sustained absence of viable channels for political
expression.\footnote{Gaventa's central insight---that sustained
  powerlessness produces not resistance but the internalization of
  quiescence---provides the closest existing theoretical analogue to the
  pattern observed in the Cambodian data, though his analysis is
  situated in a very different political context (Gaventa 1980).} Where
Lukes' third dimension of power operates by shaping preferences so that
grievances never form, demobilization by subtraction operates one step
later: grievances may persist, but the perceived vehicle for their
expression has been eliminated, producing a cascade of behavioral and
attitudinal adjustment that is visible across multiple survey dimensions
simultaneously.\footnote{The distinction matters: Lukes' third dimension
  operates \emph{before} grievances form; demobilization by subtraction
  operates \emph{after} grievances have formed and been politically
  activated, removing the vehicle for their expression rather than the
  grievances themselves (Lukes 2005).}
...
early-to-mid 2017, based on internal temporal references: the
questionnaire references the 2016--17 school year as current, the 2016
commune budget as the most recently completed fiscal cycle, and
``additional money paid to officials in 2016'' as a retrospective
question about the immediately preceding year. This timing places the
SES fieldwork in the final months before the intensification of
political closure---after the collapse of the Culture of Dialogue but
before Kem Sokha's arrest in September 2017 and the CNRP dissolution in
November 2017.
...
The current analysis expands the treatment of democratic attitudes
beyond the 0--10 expectation items employed in earlier drafts,
incorporating measures of democratic commitment, democratic
prioritization, and democratic satisfaction alongside democratic
expectations. The expanded battery addresses a measurement concern that
has become increasingly salient in the comparative democratic attitudes
literature: that survey-measured ``democratic support'' is not a unitary
construct but a composite of analytically separable dimensions that may
respond differently to political conditions (Bratton et al.~2004; Mattes
and Bratton 2007).

\emph{Democratic commitment.} Two items measure abstract endorsement of
democracy as a regime form. The first, fielded in all four waves,
presents respondents with a three-option forced choice: ``Democracy is
always preferable to any other kind of government,'' ``Under some
circumstances, an authoritarian government can be preferable,'' or ``For
people like me, it doesn't matter whether we have a democratic or
non-democratic government.'' The harmonized coding runs 1 (democracy
always preferable) to 3 (doesn't matter), such that lower means indicate
stronger democratic commitment. The second, fielded in Waves 3 through
6, asks respondents to evaluate the statement ``Democracy may have its
problems, but it is still the best form of government'' on a standard
1--4 agree/disagree scale (higher = more pro-democratic). Both items
employ identical wording across all waves in which they appear.
Nonresponse rates on these items are low: under 2 percent in Waves 3 and
4, rising to 10--13 percent in Wave 6---elevated, but far below the
levels observed on the evaluative-projective items discussed below.

\emph{Democratic prioritization.} One item measures the trade-off
between political freedom and economic equality, asking respondents to
choose between ``reducing economic inequality'' and ``protecting
political freedom'' on a five-point scale (1 = inequality reduction
definitely more important, 5 = political freedom definitely more
important), with a midpoint option of ``both equally important.'' The
item was fielded in Waves 3, 4, and 6 with identical wording.
Nonresponse is minimal (1--8 percent across waves). A second trade-off
item, pitting democracy against economic development on a five-point
scale, is available across all four waves but proves empirically less
dynamic in the Cambodian case; it is reported in the appendix for
completeness.

\emph{Democratic satisfaction.} Respondents in all four waves were
asked: ``On the whole, how satisfied or dissatisfied are you with the
way democracy works in {[}Cambodia{]}?'' on a four-point scale (1 = not
at all satisfied, 4 = very satisfied). Wording is identical across
waves. Nonresponse is low (0.3--6.4 percent). This item occupies an
intermediate position between normative democratic support and regime
performance evaluation; its trajectory proves substantively central to
the normalization argument developed below.

\emph{Democratic expectations.} Three items fielded in Waves 3, 4, and 6
measure perceived democratic quality on 0--10 scales: democratic past
(how democratic was the country ten years ago?), democratic present (how
democratic is the country today?), and democratic future (how democratic
will the country be in ten years?). These items carry the highest
nonresponse rates in the democratic battery---reaching 63 percent on the
democratic future item and 43 percent on the democratic present item in
Wave 6. The elevated missingness, concentrated in Wave 6, is itself
analytically informative and is addressed at length in the alternative
mechanisms section. Because the expectations items provide the most
vivid illustration of the temporal arc documented in this article but
rest on the weakest data foundations, the analytic strategy treats them
as supporting evidence for patterns that are established more robustly
on the commitment, prioritization, and satisfaction measures.
...
independent check upon it (Blake 2019; Morgenbesser 2016). Economic
growth, driven by the garment export sector, construction, and an
expanding tourism industry, provided a material foundation for the
regime's implicit social contract: stability and modest prosperity in
exchange for political acquiescence (Hughes and Un 2011).
...
their merger four years later (Noren-Nilsson 2015).
...
The democratic orientation measures from 2008 establish a baseline of
modest, largely passive democratic sentiment. On the forced-choice
democracy preference item, 61.2 percent of respondents selected
``democracy is always preferable,'' while 30.5 percent---nearly a
third---chose ``for people like me, it doesn't matter.'' Only 8.3
percent endorsed the view that authoritarian government could sometimes
be preferable. The mean (1.69 on the 1--3 scale, where 1 represents the
strongest democratic commitment) reflects a population that leaned
democratic but without intensity: a plurality endorsed democracy as an
abstract principle, but the large ``doesn't matter'' share signals the
political indifference of a citizenry that had experienced little
meaningful democratic choice. Democracy satisfaction stood at 2.97 on a
four-point scale---essentially at the midpoint between ``not very
satisfied'' and ``fairly satisfied.'' The
democracy-versus-economic-development trade-off item produced a mean of
2.43 on a five-point scale, leaning slightly toward economic
development. These are not the numbers of a population invested in
democratic politics. They are the numbers of a population for whom
democracy was neither an aspiration nor a grievance---simply not a
salient dimension of political life.
...
and Kem Sokha, resolved the coordination problem at a stroke
(Noren-Nilsson 2015; Un 2013a). The resulting party offered voters
something genuinely new in Cambodian politics: a single, unified
alternative to the CPP with recognizable leaders, a coherent platform,
...
partially circumvented CPP control of broadcast media (Norén-Nilsson
2021; Morgenbesser 2020). The CNRP's campaign messaging---centered on
...
the stability-first bargain their parents had accepted (Norén-Nilsson
and Senior Lecturer at the Centre for East and South-East Asian Studies,
...
governed Cambodia since the late 1990s appeared to be unraveling
(Strangio 2014; Morgenbesser 2017).
...
The broader democratic orientation battery from Wave 3 reveals a more
textured picture than the expectations items alone suggest. On the
forced-choice democracy preference, 56.9 percent chose ``democracy is
always preferable''---actually \emph{lower} than in 2008 (61.2 percent),
with 30.2 percent selecting ``doesn't matter'' and 12.9 percent
endorsing conditional authoritarianism. The 2012 moment was not, in
other words, a peak of abstract democratic commitment; it was a peak of
democratic \emph{expectation} and \emph{prioritization}. The distinction
matters. Respondents who rated their country's democratic future at 9.58
on a ten-point scale were not necessarily more committed to democracy as
an ideal than their 2008 counterparts---they were more convinced that
democracy was arriving. The commitment-expectation gap in 2012---modest
abstract endorsement alongside extraordinary feasibility optimism---is
the signature of a population whose democratic orientation was driven by
perceived possibility rather than by normative conviction.

Where prioritization is concerned, the 2012 data register the high-water
mark. On the democracy-versus-equality trade-off, the
pro-political-freedom side accounted for 47.1 percent of respondents
(25.1 percent ``somewhat,'' 22.0 percent ``definitely''), while the
pro-equality side stood at 50.4 percent, with a negligible 2.5 percent
selecting ``both equally important.'' The population was almost evenly
divided, but nearly half were willing to prioritize political freedom
over material equality---a level of democratic prioritization that would
not be observed again. The ``democracy is the best form of government''
item debuted in this wave at 3.26 on a four-point scale (between
``agree'' and ``strongly agree''), the highest value it would record
across the three waves in which it was fielded. Democracy satisfaction
held steady at 2.98, essentially unchanged from 2008.
...
leaders and selective restrictions on public assembly (Morgenbesser
2017; Norén-Nilsson 2019; Schedler 2013). By 2015, the dialogue had
largely stalled, and the political atmosphere had shifted from the
hopeful if chaotic energy of 2013 to something more wary and uncertain.
It was in this atmosphere that the Wave 4 Asian Barometer survey entered
the field.
...
The democratic orientation measures from Wave 4 reveal the first signs
of the decoupling that would define the Cambodian trajectory: the
simultaneous intensification of abstract democratic commitment and
erosion of democratic expectation. On the forced-choice democracy
preference, 74.9 percent of respondents selected ``democracy is always
preferable''---the highest proportion across all four waves, up sharply
from 56.9 percent in 2012. The ``doesn't matter'' category collapsed
from 30.2 to 18.9 percent. Citizens who had been indifferent to the
democracy question in earlier waves were now choosing sides, and
choosing democracy. The shift is consistent with a political environment
in which democracy had become contested and salient---the 2013 election,
the mass protests, the crackdown---rather than the background condition
it had been in 2008. Commitment to democracy as an ideal intensified
precisely because the ideal was under visible threat. ``Democracy may
have its problems but it is still the best form of government'' dipped
modestly from 3.26 to 3.15 (\emph{p} \textless{} 0.001), a statistically
significant but substantively small decline that left the mean firmly in
``agree'' territory.

At the same moment, democratic prioritization began its descent. The
democracy-versus-equality trade-off shifted significantly toward the
equality pole: the pro-political-freedom side contracted from 47.1 to
34.6 percent, while the ``both equally'' midpoint expanded from 2.5 to
8.2 percent (mean: 2.91 → 2.58, \emph{p} \textless{} 0.001). Citizens
were declaring their commitment to democracy in the abstract while
becoming less willing to prioritize it when placed in competition with
economic equality. The pattern is not contradictory; it reflects a
population that had learned from the events of 2013--2014 that
democratic aspiration carried real costs---political instability,
economic disruption, state violence---and was beginning to weigh those
costs against the ideal even while affirming the ideal itself.

The democratic expectation measures had already begun their descent. The
democratic future rating fell from 9.58 to 7.72---a drop of nearly two
full points on the ten-point scale (\emph{p} \textless{} 0.001). The
democratic present declined from 5.85 to 5.06. Only the democratic past
held relatively steady at 3.87. Democracy satisfaction fell to
2.71---the lowest value in the four-wave series---consistent with a
widening gap between democratic expectations (still elevated at 7.72)
and perceived democratic reality (5.06). The gap between what citizens
hoped for and what they observed produced dissatisfaction; the narrowing
of that gap by Wave 6, accomplished not by improving reality but by
lowering expectations, would produce the opposite.

The configuration of the 2015 democratic orientation data is, in
retrospect, the clearest signal of the normalization process in its
early stages. Ideals intensified. Prioritization weakened. Expectations
fell. Satisfaction declined. The four dimensions, which might be
expected to move in concert if democratic attitudes were a unitary
construct, instead moved in characteristically different directions---a
pattern that the elimination of the CNRP two years later would amplify
...
Cambodia National Rescue Party.\footnote{Unless otherwise noted, the
  political chronology in this section draws on Un and Luo (2020);
  Chheang and President of the Asian Vision Institute (AVI), an
  ...
  Southeast Asia. (2021); and Morgenbesser and Pepinsky (2019)} The
...
in September 2017 after receiving a disputed tax bill of \$6.3 million
(Norén-Nilsson 2021). Radio Free Asia's Cambodian bureau was shuttered,
and several of its journalists faced criminal charges. Independent radio
stations that had broadcast opposition content were pressured to switch
to pro-government programming or cease operations entirely. Civil
society organizations faced intensified regulatory scrutiny under the
2015 Law on Associations and Non-Governmental Organizations (LANGO),
which gave the government broad discretionary power to dissolve
organizations deemed to threaten public order (Norén-Nilsson and Eng
2020).
...
but substantively emptied (Levitsky and A. 2010; Schedler 2002;
Morgenbesser and Pepinsky 2019). The 2018 national election, conducted
without the CNRP on the ballot, produced a CPP sweep of all 125 National
Assembly seats---a result that formalized what the dissolution had
...
The rise in civil servant contact to 37.2 percent in Wave 6, against the
backdrop of collapsing independent engagement, warrants careful
interpretation. This pattern need not reflect passive acquiescence
alone. In a political environment where opposition parties, independent
media, and civil society organizations have been systematically
dismantled, contacting a civil servant may represent the only remaining
channel through which citizens can address grievances or secure material
needs. The education of a citizenry, in this sense, involves not only
the lowering of democratic expectations but also a pragmatic
recalibration of political strategy: citizens learn which levers still
function and redirect their efforts accordingly. This reading preserves
a degree of agency within the normalization framework---demobilized
citizens are not necessarily inert, but their participation has been
redirected into channels that reinforce rather than challenge the
regime's institutional architecture. The result is a form of engagement
that is simultaneously rational at the individual level and
depoliticizing at the collective level.
...
proportions; t-based for means) across six thematic domains. Dashed
...
proportions (\% ever engaged). Democratic Expectations panel: 0--10
scale. Democratic Commitment panel: dem\_best\_form (1--4 mean) and
dem\_vs\_equality (1--5 mean), showing stable abstract democratic
commitment diverging from declining expectations. Source: Asian
Barometer Survey, Waves 2, 3, 4, 6.}
...
post-dissolution political closure behind it.
...
The forced-choice democracy preference item tells a subtler story. The
proportion selecting ``democracy is always preferable'' declined from
its Wave 4 peak of 74.9 percent to 66.5 percent---still a clear
majority, but a significant contraction. The critical diagnostic is
\emph{where the movement went}. The ``doesn't matter'' category, which
had contracted sharply between 2012 and 2015 (30.2 to 18.9 percent),
continued to decline to 17.5 percent---its lowest level across all four
waves. The growth was concentrated entirely in ``under some
circumstances, an authoritarian government can be preferable,'' which
more than doubled from 6.1 to 16.0 percent. This distribution is
inconsistent with generalized political apathy, which would inflate the
``doesn't matter'' category, and inconsistent with fear-driven
acquiescence, which would push respondents toward whichever option
appeared safest. It is consistent with a specific form of pragmatic
recalculation: a subset of citizens who had committed to democracy as an
ideal in 2015, when the opposition was still present, reassessed that
commitment in light of a political reality in which democratic
alternatives no longer existed. They did not become indifferent; they
became conditionally authoritarian. The distinction between apathy and
conditional acceptance is central to the normalization framework
proposed here.

Democratic prioritization---measured on an item with 8.1 percent
nonresponse, among the lowest rates in the political battery---reached
its lowest recorded level. The democracy-versus-equality trade-off
declined to a mean of 2.31 (\emph{p} \textless{} 0.001 for both the
W3→W6 and W4→W6 comparisons). The pro-political-freedom side of the
distribution, which had accounted for 47.1 percent of respondents in
2012, contracted to 21.7 percent---a collapse of more than half. The
movement was not uniform across the distribution. The ``somewhat
pro-freedom'' category suffered the steepest proportional decline (25.1
to 8.4 percent), while ``definitely pro-freedom'' eroded more modestly
(22.0 to 13.3 percent). The citizens most susceptible to
deprioritization were those whose commitment to political freedom had
been moderate and conditional---precisely the pragmatic middle that the
normalization framework predicts would be most responsive to the closure
of democratic possibility. Meanwhile, the ``both equally important''
midpoint expanded from 2.5 percent in 2012 to 15.1 percent---a sixfold
increase in the population that had retreated to noncommittal
ambivalence. These respondents are the attitudinal analogue of the
behavioral withdrawal documented in the participation data: citizens who
previously held a directional political preference and have ceased to
hold one.

The democratic expectation items continued their descent, though these
estimates rest on substantially weaker data foundations than the
commitment, prioritization, and satisfaction measures. With 63 percent
nonresponse on the democratic future item and 43 percent on the
democratic present item in Wave 6, the expectation measures describe the
orientation of the minority of respondents who retained enough political
engagement to formulate a numerical judgment about Cambodia's democratic
trajectory. The patterns are reported here as supporting evidence for
the normalization dynamics established above on more robust measures,
not as independent findings. The democratic future rating fell from 7.72
in 2015 to 6.67 in 2021 (\emph{p} \textless{} 0.001), extending the
decline from the extraordinary 9.58 recorded in 2012 to a level that,
while still modestly optimistic, represents a drop of nearly three
points---roughly 30 percent of the available scale range---across nine
years. Democratic present stood at 5.77, essentially unchanged from 2012
(5.85), while the democratic past rose to 4.78---the only democratic
measure to increase between 2012 and 2021. Among respondents who
answered, the upward revision of the past alongside the downward
revision of the future is suggestive of a flattened temporal
perspective---though this interpretation necessarily rests on a selected
subsample and should be treated as illustrative rather than definitive.

The most robust single finding from the Wave 6 democratic orientation
battery---measured on an item with only 6.4 percent nonresponse, on
identical wording across all four waves---is the satisfaction paradox
(Linde and Ekman 2003; Valgarðsson and Devine 2022). Democracy
satisfaction rose to 3.10, the highest value across all four waves and a
statistically significant increase from both the Wave 4 trough of 2.71
(\emph{p} \textless{} 0.001) and the Wave 3 value of 2.98 (\emph{p}
\textless{} 0.001). On the surface, this is paradoxical: satisfaction
with democracy reached its peak in the least democratic moment in the
country's modern history, three years after a one-party election in
which the CPP won every seat. The paradox dissolves under the
normalization framework. Satisfaction is a function of the gap between
expectations and perceived reality. In 2015, expectations remained
elevated while reality was visibly deteriorating, producing a large gap
and low satisfaction. By 2021, expectations had collapsed while the
regime was delivering stability and modest service provision through its
patronage infrastructure. The gap closed from below, and satisfaction
rose. Citizens became more satisfied with ``the way democracy works''
not because democratic quality improved---by any external assessment it
deteriorated dramatically---but because they had recalibrated their
understanding of what ``democracy'' meant in the Cambodian context. The
satisfaction recovery is the clearest single indicator of normalization
in the dataset: it shows adaptive preference formation operating in real
time, as citizens adjusted their evaluative standards to accommodate the
available political reality.
...
analysis of political compliance in Hafez al-Assad's Syria, where
citizens participated in elaborate public rituals of regime praise not
because they believed the regime's claims but because acting as if they
believed was the condition of ordinary life (Wedeen 1998, 2000). The
Cambodian case differs from Wedeen's Syria in a respect that is not
incidental but analytically fundamental. Wedeen's compliance is
performative: citizens maintain private skepticism while publicly
enacting belief, producing a gap between inner conviction and outer
behavior that defines the regime's mode of domination. The Cambodian
pattern visible in the ABS data is not performative in this sense. The
survey responses are private---administered in face-to-face interviews
with confidentiality protocols, not in public settings where social
surveillance operates. The attitudinal shifts documented here appear to
reflect genuine reorientation, not strategic concealment: citizens moved
into conditional authoritarianism rather than into noncommittal safe
responses, and the shifts cut across demographic subgroups and partisan
categories in ways that fear-based models do not predict. What the
Cambodian case shares with Wedeen's Syria is not the mechanism but the
outcome: a population that has arranged its cognitive and evaluative
life around the available political reality, not because it has been
persuaded of the regime's virtue but because it has incorporated the
regime's permanence as a background condition of practical reasoning.
The difference is that Wedeen's Syrians \emph{performed} accommodation
while potentially preserving private dissent; the Cambodian data suggest
something closer to the internalization of accommodation---or at
minimum, the erosion of the psychological infrastructure required to
sustain dissent in the absence of institutional support.

The democracy-versus-equality trajectory---from near-parity in 2012 to a
two-to-one margin favoring equality over political freedom by
2021---bears the hallmarks of what Elster termed adaptive preference
formation: the adjustment of desires to match perceived possibilities,
the ``sour grapes'' mechanism through which agents come to devalue what
they cannot obtain (Elster 2016, orig. 1983; Przeworski 2022). The
Cambodian case, however, reveals a more complex process than Elster's
formulation anticipates. The adaptation is partial. Citizens
deprioritized political freedom when placed in explicit competition with
equality, and they lowered their expectations of democratic progress,
but they did not revise their abstract endorsement of democracy as the
best form of government. The ideal persisted even as the practical
commitment to it eroded. This partial adaptation is theoretically
consequential: it suggests that democratic values operate at multiple
psychological levels, some of which are more responsive to political
context than others (Jones and Cowan 2025). The surface layer---abstract
endorsement---proves resilient to even dramatic changes in the structure
of political alternatives. The operational layer---the willingness to
bear costs for democratic outcomes---proves highly elastic. A regime
that successfully eliminates alternatives need not worry about what
citizens believe in principle; it need only wait for the practical
implications of that belief to atrophy.
...
External assessments corroborate the interpretation that declining
witnessed corruption reflects perceptual withdrawal rather than actual
improvement. Cambodia's score on Transparency International's Corruption
Perceptions Index remained essentially flat throughout the study period,
moving from 21 in 2015 to 23 in 2021 on a 100-point scale---consistently
ranking the country among the most corrupt in Southeast Asia and
globally (Transparency International 2023). Reports from domestic and
international monitoring organizations continued to document endemic
corruption in land concessions, public procurement, and the judiciary
throughout the period in which survey respondents' reported witnessing
of corruption collapsed from 49 to 15 percent. The gap between external
expert assessments, which registered no meaningful improvement, and
citizens' reported experience, which registered a fourfold decline, is
difficult to reconcile with genuine anti-corruption progress. It is,
however, consistent with a population that has progressively withdrawn
from the administrative and political sites where corruption is
encountered---not because corruption diminished, but because the reasons
and opportunities for engaging with state institutions outside
officially sanctioned channels have.
...
perceived official expectations.\footnote{On the reliability of survey
  responses under electoral authoritarianism, see Schedler and Sarsfield
  (2007) Frye et al. (2017) demonstrate that even in semi-competitive
...
would comply; government employees were required to participate (McCargo
2018). Voting in a one-party election is not a political act in the same
sense as voting in a competitive one; it is closer to a demonstration of
compliance, a public performance of belonging to the political community
as the regime defines it. The fact that turnout rises precisely as
...
point considerably (Strangio 2020).
...
The expanded democratic orientation battery provides additional leverage
against the preference-falsification hypothesis. The response
distributions on two forced-choice items are particularly informative.
On the democracy-versus-equality trade-off, the Wave 6 shift moved
respondents primarily into the noncommittal midpoint (``both equally
important,'' expanding from 2.5 to 15.1 percent) rather than toward the
pro-regime pole (which grew modestly). A frightened population seeking
the socially safe answer in an authoritarian context would be expected
to choose the answer that aligns with perceived regime preferences---in
this case, prioritizing equality over political freedom, consistent with
the CPP's developmental rhetoric. Instead, the largest category of
movement was into ambivalence. Similarly, on the forced-choice democracy
preference, the Wave 6 growth concentrated in ``authoritarian sometimes
preferable'' (6.1 to 16.0 percent) rather than in ``doesn't matter''
(which actually continued to decline, from 18.9 to 17.5 percent). If
survey reticence were the primary driver, the noncommittal option---the
safest refuge for a respondent unwilling to stake a position---would be
expected to expand. It contracted. The growth of conditional
authoritarianism alongside the contraction of apathy is more consistent
with citizens who have genuinely reassessed the trade-offs between
regime types than with citizens concealing stable preferences behind
safe responses.
...
private attitudes likely widens as political space narrows further (Frye
et al. 2017).

The nonresponse gradient across the democratic orientation battery in
Wave 6 is itself analytically informative. The items with the lowest
nonresponse---``democracy is the best form of government'' (9.9
percent), the democracy-versus-equality trade-off (8.1 percent), the
forced-choice democracy preference (13.4 percent)---are agree/disagree
or forced-choice items that require respondents to select among
pre-defined positions. The items with the highest
nonresponse---democratic future (63 percent), democratic present (42.5
percent)---are evaluative-projective items that require respondents to
generate a numerical judgment about Cambodia's democratic trajectory.
The cognitive and political demands of these two classes of items differ
substantially. Placing Cambodia's democratic future on a ten-point scale
requires both the political engagement to hold an opinion about the
country's trajectory and the willingness to commit that opinion to a
number. Selecting ``agree'' or ``disagree'' on whether democracy is the
best form of government requires neither.

The nonresponse gradient thus maps onto the normalization framework.
Citizens can still answer whether democracy is desirable in the abstract
(low cost, low sensitivity), but increasingly decline to evaluate where
their country sits on a democratic continuum (high cost, high
sensitivity, or---per the theory---genuine absence of a formed opinion
because the question has lost practical relevance). The 63 percent who
did not answer the democratic future item and the 37 percent who
answered with diminished expectations are not competing narratives but
complementary expressions of the same process. The former have
disengaged from the question entirely; the latter have revised their
answer downward.

Bounds analysis confirms that the headline decline is robust to extreme
assumptions about the missing respondents. If all nonrespondents on the
democratic future item in Wave 6 are imputed at the maximum scale value
of 10---the most conservative possible assumption, granting every
missing respondent the most optimistic democratic expectation---the
resulting population mean is 8.77. Even under this extreme scenario, the
decline from the Wave 3 value of 9.58 remains 0.81 points---substantial
and directionally unambiguous even under this most favorable possible
assumption. The core finding that democratic expectations fell
substantially between 2012 and 2021 is not an artifact of differential
nonresponse.
...
If demobilization by subtraction operates specifically through the
removal of the opposition---rather than through the generalized closure
of political space---the resulting attitudinal shifts should concentrate
among citizens who were politically attached to the dissolved party.
Former CNRP supporters, who lost their vehicle for political expression,
should exhibit steeper declines in democratic expectation and civic
engagement than CPP supporters, whose political home remained intact.
The ABS vote choice items, which identify respondents' reported partisan
behavior in the most recent national election, permit a direct test of
this prediction.
...
The second consideration is theoretical, and it reframes the uniformity
finding as consistent with---rather than contradictory to---the
subtraction mechanism, once the mechanism is specified at the correct
level of analysis. The prediction that CNRP supporters should be
differentially affected assumes that subtraction operates like losing
one's team: supporters of the dissolved party lose their political
vehicle while everyone else is unaffected. The framework advanced in
this article operates at a different level. The removal of the credible
alternative restructures the political field itself---the horizon of
possibility for all participants, not only those who identified with the
opposition. CPP voters in 2015 inhabited a competitive political system
in which their party could face genuine electoral challenge, in which
political information served a decision-making function, and in which
contacting influential persons outside the party apparatus had strategic
rationale. CPP voters in 2021 inhabited a one-party state in which none
of these conditions obtained. The elimination of the CNRP depoliticized
the system as a whole, reducing the informational and participatory
incentives for all citizens regardless of partisan attachment. Under
this reading, the uniformity of the observed shifts is precisely what a
field-level mechanism would predict---and what a party-level mechanism
would not.
...
In early-to-mid 2017, 86.1 percent of SES respondents agreed that
``people in this commune are free to speak what they think without
fear,'' and 87.9 percent agreed that ``people in this commune can join
any organisation they like without fear.'' The perceived freedom to vote
for any party without fear stood at 94.0 percent---near-universal
agreement, recorded in the final months before the elimination of the
only meaningful alternative party. These figures establish that on the
eve of the crackdown, Cambodian citizens overwhelmingly perceived
themselves as living in a civic environment that permitted free
expression, association, and partisan choice. The political closure that
followed was not acting on a population that already felt constrained.
The subjective distance between the pre-dissolution civic environment
(as perceived by citizens) and the post-dissolution environment
documented in the ABS Wave 6 data was, by these measures, substantial.

The tea money item corroborates the corruption trajectory from a
different instrument and a more behaviorally concrete measure. In the
SES, 34.9 percent of respondents reported that they or a household
member had paid additional money to government officials in 2016 to
``get things done or get things done faster.'' This rate---measuring
direct personal bribery experience rather than the broader ``witnessed
or experienced'' formulation used in the ABS---confirms that petty
corruption remained widespread in the immediate pre-dissolution period.
The ABS witnessed-corruption item registered 63 percent in 2015 and 15
percent in 2021; the SES tea money rate of 34.9 percent for 2016,
falling between these values on a narrower and more concrete measure, is
consistent with a corruption environment that had not materially
improved before the dissolution. The subsequent ABS collapse is thus
more difficult to attribute to genuine anti-corruption progress and more
consistent with the exposure-reduction and social-desirability
...
The broader pattern of SES data availability reinforces the temporal
argument. Detailed governance modules comparable to the items analyzed
here were not publicly released for the 2018--2020 period; the only
post-dissolution SES data available contain a single item on
satisfaction with the government's handling of COVID-19. The systematic
unavailability of civic orientation data from the years immediately
following the CNRP dissolution---across both the ABS and the
SES---reflects the same political closure the article documents and
limits the temporal precision with which the attitudinal shifts can be
dated.
...
intensified authoritarianism (Aassve et al. 2021). However, the fact
that this is the only non-political item showing a substantial
...
interpretation.} A distinct methodological concern cuts across all of
the preceding adjudication tests: the six-year gap between Wave 4 (2015)
and Wave 6 (2021) means the analysis cannot determine the temporal
profile of the observed shifts. Three models are consistent with the
available data. The first---an acute shock model---holds that the
sharpest attitudinal changes occurred in the immediate aftermath of the
CNRP dissolution in November 2017 and the one-party election of July
2018, and that the 2021 data capture a population that has already
partially recovered from the initial shock. Under this model, the 2021
values understate the peak magnitude of demobilization. The second---a
gradual normalization model---holds that the shifts accumulated
incrementally across the 2017--2021 period as the consequences of
political closure compounded through informational feedback loops and
the progressive atrophy of civic habits. Under this model, the 2021 data
capture the endpoint of a process still in motion. The third---a
repression-with-subtraction model---holds that the observed shifts are
not primarily products of field restructuring but of the cumulative
repressive apparatus that accompanied the dissolution: media closures,
civil society restrictions, legal harassment, and the chilling effects
of the criminalization of the opposition. Under this model, subtraction
is a component of a standard authoritarian consolidation package rather
than a distinctive mechanism.

The available data cannot definitively adjudicate among these three
models, and the honest answer is that elements of all three likely
operated simultaneously. Two considerations, however, favor the
subtraction-centered interpretation over the repression-centered
alternative. First, the attitudinal trajectory began before the most
intensive period of repression: democratic future expectations fell by
nearly two points and political interest declined measurably between
Wave 3 (2012) and Wave 4 (2015), a period during which the CNRP was
under selective pressure but still functionally intact and the broader
repressive apparatus had not yet been deployed. If cumulative repression
were the primary driver, the onset of attitudinal change should
concentrate in the post-2017 period rather than emerging incrementally
from the peak of mobilization. Second, the domain-specificity of the
shifts---political attitudes and behaviors declining while non-political
attitudes remain stable---is more consistent with a mechanism that
operates through the structure of political alternatives than with
generalized intimidation, which would be expected to depress expressed
attitudes across domains. The interpretation advanced here treats the
dissolution as the keystone of the closure process: the act that
restructured the political field and set in motion the cascading
adjustments documented in the data, even as the accompanying repressive
measures amplified and accelerated those adjustments.
...
The first concerns the mechanism itself, and the expanded democratic
orientation analysis permits a more precise formulation than earlier
treatments. Demobilization by subtraction does not operate by eroding
democratic values. Abstract democratic commitment---measured by the most
widely used items in the cross-national survey toolkit---remained
essentially stable across the Cambodian study period; a clear majority
of respondents in 2021 continued to endorse democracy as the best form
of government at rates statistically indistinguishable from the peak
mobilization of 2012. What collapsed was not the ideal but the
willingness to prioritize that ideal against competing goods---and, on
the more tentatively measured expectation items, the perceived horizon
within which the ideal could be realized. The pro-political-freedom
share of the democracy-versus-equality trade-off contracted from 47 to
22 percent. Democracy satisfaction---paradoxically---rose to its highest
recorded level, as citizens recalibrated their evaluative standards to
accommodate a political reality in which the democratic alternative had
been removed. Democratic expectations, measured on items carrying
substantially higher nonresponse, fell by nearly three points on a
ten-point scale---a decline that, while directionally robust even under
extreme imputation assumptions, rests on a selected subsample and
corroborates rather than independently establishes the normalization
pattern. The divergence between resilient ideals and collapsing
prioritization suggests that democratic attitudes in authoritarian
contexts are not the unitary construct that much of the democratic
values literature assumes. They have at least three partially
independent dimensions---ideal endorsement, practical prioritization,
and feasibility expectation---that respond to the structure of available
political alternatives in characteristically different ways (Jones and
Cowan 2025). The mechanism, moreover, need not be attributed to the
dissolution alone. The Cambodian closure involved the simultaneous
elimination of the opposition party, independent media, and civil
society organizations---a compressed sequence whose individual
contributions cannot be isolated with the available data. The
theoretical claim is that the \emph{combined} effect of eliminating the
political alternative and its supporting ecosystem produces the
divergence pattern documented here, not that any single act within the
sequence is independently sufficient. Cross-national surveys that
aggregate these dimensions into a single ``democratic support'' index
may be measuring a composite whose components move in opposite
directions under precisely the conditions of greatest theoretical
interest.

The second implication concerns the relationship between hope and
democratic attitudes. The Wave 3 data, viewed alongside the expanded
orientation battery, suggest that the extraordinary democratic optimism
of 2012 was not accompanied by correspondingly extraordinary democratic
commitment. The forced-choice democracy preference actually registered
\emph{lower} in 2012 than in 2015,
when---counterintuitively---commitment surged to its highest level
precisely as expectations were falling. This temporal decoupling
suggests that democratic support in authoritarian contexts may be driven
by two distinct psychological mechanisms that peak at different moments:
feasibility perception, which responds to the structure of political
opportunities and peaked when the CNRP made democracy appear imminent;
and value crystallization, which responds to perceived threat and peaked
when the post-2013 crackdown placed democratic values under visible
siege. The Cambodian sequence---commitment lagging expectation on the
upswing, then outlasting it on the downswing---challenges the
foundational assumption of the political culture tradition that
democratic values and democratic expectations move in tandem as
expressions of a single underlying orientation.\footnote{The canonical
  formulation of democratic values as a stable cultural attribute is
  found in the political culture tradition from Inglehart (1997) onward.
  The Cambodian data suggest a more situationally contingent model in
  which the components of democratic support are decoupled---closer to
  what Bratton and Mattes have termed ``demand for democracy'' as a
...
gradually across the broader closure process. Nor can the design isolate
the specific contribution of the dissolution from the accompanying media
shutdowns, civil society restrictions, and electoral manipulation that
constituted the full authoritarian consolidation sequence. The elevated
nonresponse on democratic expectation items in Wave 6---reaching 63
percent on the democratic future measure---means the attitudinal
estimates from 2021 are based on the subset of respondents willing to
venture an opinion, which may disproportionately exclude those with the
strongest pro-democratic views or, alternatively, those least engaged
with politics. A direct test of whether fear of speech drives this
missingness is available from the ABS freedom-of-speech and
freedom-of-assembly items: a logistic regression predicting nonresponse
on the Wave 6 democratic future item, controlling for education and
urbanicity, finds that neither perceived freedom of speech (OR = 1.01,
\emph{p} = 0.95) nor perceived freedom to organize (OR = 0.9, \emph{p} =
0.36) predicts missingness. Respondents who feel less free to speak are
no more likely to skip the democratic future question than those who
feel more free, indicating that the elevated nonresponse rate is not the
signature of a population censoring itself out of fear.

A methodological caution is warranted regarding the 63 percent
non-response rate on the democratic future item in Wave 6. This level of
missingness means that the reported 2021 mean is effectively a survivor
statistic, reflecting only those respondents who retained enough
political engagement---or perhaps political imagination---to formulate
an expectation about Cambodia's democratic trajectory at all. Yet this
limitation is also, in a sense, the study's most striking finding. If
demobilization by subtraction operates by narrowing the horizon of
political possibility, then the inability or unwillingness of nearly
two-thirds of respondents to venture an opinion about Cambodia's
democratic future is not merely a data problem to be corrected; it is
the condition the framework predicts. The silence of the 63 percent and
the diminished expectations of the 37 percent who answered are not
competing narratives but complementary expressions of the same process.
The former have disengaged from the question entirely; the latter have
revised their answer downward. Both constitute evidence of a citizenry
educated out of democratic expectation, albeit through different
registers of withdrawal.

The preceding section on alternative mechanisms has addressed the
pandemic, generational, and preference-falsification concerns in detail;
the conclusion here is that these factors may amplify specific estimates
but cannot account for the overall pattern. Finally, any single-country
...
moments.\footnote{Two contextual anomalies warrant specific
  ...
  and Sarsfield (2007) Furthermore, the single-country focus of this
...
Bratton, Michael, Robert Mattes, and E Gyimah-Boadi. 2004.
...
Chheang, Vannarith, and President of the Asian Vision Institute (AVI),
an independent think-tank based in Phnom Penh, Cambodia. He is a public
policy analyst specializing in geopolitics and political economy of
Southeast Asia. 2021. {``{Cambodia in 2020: Regime legitimacy
...
\emph{{Repression And Mobilization}}. Edited by Carol Mueller. Social
...
Elster, Jon. 2016. \emph{{Cambridge philosophy classics: Sour grapes:
Studies in the subversion of rationality}}. 2nd ed. Cambridge University
Press.
...
Hughes, Caroline, and Kheang Un, eds. 2011. \emph{{Cambodia's Economic
Transformation}}. NIAS Studies in Asian Topics Series. NIAS Press.
...
Levitsky, Steven, and Lucan A. 2010. \emph{{Problems of international
...
authoritarianism in southeast Asia}}. Elements in Politics and Society
in Southeast Asia. Cambridge University Press.
\url{https://doi.org/10.1017/9781108630061}.
...
Noren-Nilsson, Astrid. 2015. {``{Cambodia at a crossroads. The
...
Norén-Nilsson, Astrid, and Senior Lecturer at the Centre for East and
South-East Asian Studies, Lund University. 2021. {``{Youth mobilization,
power reproduction and Cambodia's authoritarian turn}.''}
\emph{Contemporary Southeast Asia} 43: 265--92.
\url{https://doi.org/10.1355/cs43-2c}.
...
Limongi. 2000. \emph{{Cambridge studies in the theory of democracy:
Democracy and development: Political institutions and well-being in the
world, 1950-1990 series number 3: Political institutions and well-being
...
Un, Kheang. 2012. {``{Cambodia in 2011: A thin veneer of change}.''}
\emph{Asian Survey} 52 (February): 202--9.
\url{https://doi.org/10.1525/as.2012.52.1.202}.
...
\addcontentsline{toc}{subsection}{Table A3: Placebo
Battery---Non-Political Variables}
...
\subsection*{Table A4: W3→W4 Partisan
Decomposition}\label{table-a4-w3w4-partisan-decomposition}
\addcontentsline{toc}{subsection}{Table A4: W3→W4 Partisan
Decomposition}
...
\subsection*{Table A5: W6 DK/Refuse Group Attitudinal
Profile}\label{table-a5-w6-dkrefuse-group-attitudinal-profile}
\addcontentsline{toc}{subsection}{Table A5: W6 DK/Refuse Group
Attitudinal Profile}
...
\subsection*{Table A6: OLS Attenuation Tests---Freedom
Perceptions}\label{table-a6-ols-attenuation-testsfreedom-perceptions}
\addcontentsline{toc}{subsection}{Table A6: OLS Attenuation
Tests---Freedom Perceptions}
...
\subsection*{Table A7: Wave × Freedom Interaction
Models}\label{table-a7-wave-freedom-interaction-models}
\addcontentsline{toc}{subsection}{Table A7: Wave × Freedom Interaction
Models}
...
\subsection*{Table A8: Nonresponse Prediction---Logistic Regression
(Wave
6)}\label{table-a8-nonresponse-predictionlogistic-regression-wave-6}
\addcontentsline{toc}{subsection}{Table A8: Nonresponse
...
\subsection*{Table A9: Bounds Analysis---Democratic Future
Expectations}\label{table-a9-bounds-analysisdemocratic-future-expectations}
\addcontentsline{toc}{subsection}{Table A9: Bounds Analysis---Democratic
Future Expectations}
