...
, but the wave-over-wave decline from the 2012 peak narrows to rather
than disappearing. Assigning nonrespondents the midpoint of the scale
produces a W6 mean of , with a cumulative decline of from the Wave 3
baseline---a magnitude comparable to the observed respondent-only
estimate. Only the most extreme assumption, assigning all nonrespondents
a score of zero, could mechanically reverse the trajectory, and that
assumption requires believing that the missing respondents are, without
exception, deeply anti-democratic---the opposite of the fear-concealment
