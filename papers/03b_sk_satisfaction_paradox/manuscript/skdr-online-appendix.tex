...
\bottomrule
\multicolumn{5}{l}{\textsuperscript{} OLS b (econ\_index) with wave FE and standard controls. SE in parentheses. *p < .05, **p < .01,}\\
\multicolumn{5}{l}{***p < .001.}\\
\end{tabular}
...
\toprule
Country & Group & Dem always preferable & Satisfaction with democracy\\
\midrule
...
\bottomrule
\multicolumn{4}{l}{\textsuperscript{} OLS coefficient on econ\_index with wave FE and standard controls. SE in parentheses. *p < .05, **p < .01, ***p < .001.}\\
\end{tabular}
...
Reject single-party & -0.096*** (0.023) & 7,446 & -0.078*** (0.014) & 8,502\\
\bottomrule
\multicolumn{5}{l}{\textsuperscript{} Pooled OLS b (econ\_index) with wave FE and standard controls. SE in parentheses. *p < .05, **p <}\\
\multicolumn{5}{l}{.01, ***p < .001.}\\
\end{tabular}
