...
#   - single_party_rule
#
# These are included in analysis_data.rds (built by 00_data_preparation.qmd).
# auth_index (nostalgia direction) and auth_reject_index (rejection direction)
# are both already constructed.
# =============================================================================
