...
save_plot <- function(plot_obj, file_stem, width, height, dpi = 300) {
  ggsave(paste0("figures/", file_stem, ".pdf"), plot_obj,
         width = width, height = height)
  ggsave(paste0("figures/", file_stem, ".png"), plot_obj,
...
fig1
save_plot(fig1, "fig1_trajectories", width = 14, height = 9)
```
...
fig2
save_plot(fig2, "fig2_pre_post_nsl", width = 13, height = 6)
```
...
outlier_vars <- list(
  ...
  list(var = "dem_free_speech",
       title = "Free to Speak Without Fear\n(1=strongly disagree, 4=agree)")
)
...
fig3
save_plot(fig3, "fig3_cross_national", width = 14, height = 10)
```
...
fig4
save_plot(fig4, "fig4_flipped_correlation", width = 14, height = 5)
```
...
fig5
save_plot(fig5, "fig5_trust_trajectories", width = 13, height = 5.5)
```
...
fig6
save_plot(fig6, "fig6_monthly_timeline", width = 14, height = 9)
```
...
fig7
save_plot(fig7, "fig7_hk_tw_divergence", width = 14, height = 9)
```
...
fig8
save_plot(fig8, "fig8_zscore_heatmap", width = 15, height = 9)
```
