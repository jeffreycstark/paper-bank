...
#| tbl-cap: "Variable definitions, scales, and coding for all variables used in the analysis."

var_defs <- tribble(
  ~Variable, ~Scale, ~Category, ~Description,
  "Trust in police", "1--4", "Institutional trust",
    "Degree of trust in the police (1 = none at all, 4 = a great deal).",
  "Trust in national government", "1--4", "Institutional trust",
    "Degree of trust in the national government.",
  "Trust in president/CE", "1--4", "Institutional trust",
    "Degree of trust in the president or chief executive.",
  "Trust in parliament", "1--4", "Institutional trust",
    "Degree of trust in the parliament or legislature.",
  "Trust in courts", "1--4", "Institutional trust",
    "Degree of trust in the courts of justice.",
  "Trust in civil service", "1--4", "Institutional trust",
    "Degree of trust in the civil service.",

  "Democracy suitability", "1--10", "Democratic attitudes",
    "How suitable is democracy for the respondent's country (1 = completely unsuitable, 10 = completely suitable).",
  "Extent of current democracy", "1--10", "Democratic attitudes",
    "How democratic the respondent rates the current political system (1 = completely undemocratic, 10 = completely democratic).",
  "Current government rating", "1--10", "Democratic attitudes",
    "How dictatorial or democratic the current government is perceived to be (1 = very dictatorial, 10 = very democratic).",
  "Democracy always preferable", "1--3", "Democratic attitudes",
    "Whether democracy is always preferable (1), authoritarian government is sometimes preferable (2), or it doesn't matter (3).",
  "Democratic satisfaction", "1--4", "Democratic attitudes",
    "Satisfaction with the way democracy works (1 = not at all satisfied, 4 = very satisfied).",

  "Freedom to organize", "1--4", "Governance quality",
    "Agreement that people are free to join any organization without fear (1 = strongly disagree, 4 = strongly agree).",
  "Freedom of speech", "1--4", "Governance quality",
    "Agreement that people can speak freely without fear (1 = strongly disagree, 4 = strongly agree).",
  "Elections free and fair", "1--4", "Governance quality",
    "Rating of how free and fair the last election was (1 = not free or fair, 4 = completely free and fair).",
  "Rich and poor treated equally", "1--4", "Governance quality",
    "Assessment of whether rich and poor are treated equally under the law.",

  "System deserves support", "1--4", "System support",
    "Agreement that the political system deserves support even when it runs into problems (1 = strongly disagree, 4 = strongly agree).",
  "System pride", "1--4", "System support",
    "Degree of pride in the country's system of government.",

  "Political interest", "1--4", "Control",
    "Self-reported level of interest in politics (1 = not at all interested, 4 = very interested).",
  "Willing to emigrate", "1--4", "Control",
    "Willingness to live in another country if given the opportunity.",

  "Essential element of democracy", "Categorical", "Derived",
    "Forced-choice item: most essential element of democracy (1 = free expression, 2 = free elections, 4 = basic necessities, 5 = clean governance).",
  "Procedural vs.\\ substantive", "0/1", "Derived",
    "Binary indicator derived from the essential element item (0 = substantive conception, 1 = procedural conception)."
)

var_defs |>
  select(Variable, Scale, Description) |>
  kable(booktabs = TRUE) |>
  kable_styling(latex_options = c("scale_down", "hold_position")) |>
  pack_rows("Institutional trust", 1, 6) |>
  pack_rows("Democratic attitudes", 7, 11) |>
  pack_rows("Governance quality", 12, 15) |>
  pack_rows("System support", 16, 17) |>
  pack_rows("Control variables", 18, 19) |>
  pack_rows("Derived variables", 20, 21)
```
