...
var_defs <- tribble(
  ...
  "Democracy suitability", "Q---", "1--10", "Higher = more suitable", "How suitable is democracy for [country]?",
  "Trust in police", "Q---", "1--4", "Higher = more trust", "How much trust do you have in the police?",
  "Trust in national government", "Q---", "1--4", "Higher = more trust", "How much trust do you have in the national government?",
  "Trust in president/CE", "Q---", "1--4", "Higher = more trust", "How much trust do you have in the president/chief executive?",
  "Trust in courts", "Q---", "1--4", "Higher = more trust", "How much trust do you have in the courts?",
  "Trust in parliament", "Q---", "1--4", "Higher = more trust", "How much trust do you have in the parliament/legislature?",
  "Trust in military", "Q---", "1--4", "Higher = more trust", "How much trust do you have in the military?",
  "Democracy always preferable", "Q---", "1--3", "Higher = stronger preference", "Democracy is always preferable / sometimes authoritarian / doesn't matter",
  "Democratic satisfaction", "Q---", "1--4", "Higher = more satisfied", "How satisfied are you with the way democracy works?",
  "Freedom to organize", "Q---", "1--4", "Higher = more free", "People are free to organize groups or join any political organization",
  "Press censors views", "Q---", "1--4", "Higher = more censorship", "Media censors opposition viewpoints",
  "Govt responds to people", "Q---", "1--4", "Higher = more responsive", "Government responds to what people want",
  "Elections free and fair", "Q---", "1--4", "Higher = more fair", "Elections are free and fair",
  "System deserves support", "Q---", "1--4", "Higher = more support", "Our system of government deserves support",
  "System needs major change", "Q---", "1--4", "Higher = more change needed", "Our system of government needs major change",
  "Willing to emigrate", "Q---", "varies", "Higher = more willing", "Willingness to emigrate from country"
)
...
**Note:** The `Q---` item codes should be replaced with the exact ABS questionnaire item numbers from the Wave 5 codebook before final submission.
...
The main text reports that Hong Kong is the only ABS country where the correlation between democratic preference ("democracy is always preferable") and democratic satisfaction is positive ($r \approx +0.13$). This section computes the 95% confidence interval for this correlation and decomposes it by fieldwork period.
