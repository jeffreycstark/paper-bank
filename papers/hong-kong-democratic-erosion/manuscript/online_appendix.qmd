...
The gradient figure for Venezuela is presented in @fig-gradient-ven-nic in the main text.
...
The gradient figure for Nicaragua is presented alongside Venezuela in @fig-gradient-ven-nic in the main text.
