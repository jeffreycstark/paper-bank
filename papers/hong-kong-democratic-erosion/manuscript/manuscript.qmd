...
The sensitivity gradient is not a universal feature of democratic erosion. Preliminary application of the same framework to Venezuela (bracketing the 2017 constituent assembly crisis) and Nicaragua (bracketing the 2018 April crackdown) using Latinobarómetro data reveals broad-based institutional trust collapse without the differential item pattern characteristic of preference falsification. In both cases, trust in coercive institutions declined alongside democratic evaluations, consistent with genuine disillusionment rather than strategic compliance. These null cases provide discriminant validity: the gradient framework identifies a specific distortion signature rather than flagging all survey change as suspicious, and its absence in Venezuela and Nicaragua is consistent with contexts where repression was less targeted at survey-accessible populations or where exit options were more constrained.
