---
title: "When Do Surveys Produce False Positives for Regime Support? A Sensitivity Gradient Approach to Democratic Backsliding"
author:
  - name: Jeffrey Stark
    affiliations:
...
date: today
abstract: |
  Scholars of democratic backsliding rely on survey data to track regime legitimacy, yet the same repressive forces that dismantle institutions also distort the instruments used to measure public attitudes. This article develops a "sensitivity gradient" framework for identifying when survey measures produce false positives for regime support during authoritarian consolidation. The approach exploits variation in the political costliness of different survey items: under repression, high-sensitivity items (trust in coercive institutions) should inflate more than low-sensitivity items (abstract democratic evaluations), generating a predictable pattern of divergence. I test the framework using a natural quasi-experiment created by the disruption of the Asian Barometer Survey (Wave 5) in Hong Kong, where fieldwork was split across the 2019 pro-democracy protests and the post-National Security Law period. Three findings emerge. First, the sensitivity gradient predicts the observed "trust paradox": trust in police surged ($d \approx +0.49$) while democracy suitability collapsed ($d = -0.54$), with magnitudes tracking each institution's coercive salience. Second, the canonical "critical citizens" correlation reverses in post-NSL Hong Kong---the only such case among fifteen Asian polities---providing a diagnostic signal that standard survey relationships have broken down. Third, decomposition reveals this reversal is driven by respondents with procedural democratic conceptions, inconsistent with authoritarian co-optation and consistent with strategic falsification among the regime's most likely critics. The sensitivity gradient approach requires no experimental design, works with standard survey batteries, and can be applied retrospectively to any survey fielded during a period of political change.
keywords:
  - survey validity
...
format:
  ...
  html:
    ...
    number-sections: true
    theme: cosmo
bibliography: ../../hong-kong-democratic-erosion/manuscript/references.bib
...
Scholars of democratic erosion rely heavily on public opinion data to diagnose how citizens respond to institutional decay [@Claassen2020-hk; @Svolik2019-zi]. Cross-national survey programs---the Asian Barometer, the World Values Survey, Afrobarometer, Latinobarómetro---provide the empirical backbone for claims about regime legitimacy, democratic resilience, and the prospects for authoritarian reversal. The implicit assumption underwriting this enterprise is that survey instruments retain their validity even as the political environment deteriorates. But this assumption faces a fundamental identification challenge: the same repressive forces that dismantle democratic institutions also reshape the conditions under which citizens respond to surveys about those institutions. When a regime cracks down, does a rise in reported institutional trust reflect genuine "authoritarian resilience"---or merely the silence of the critics?

Distinguishing between these possibilities is notoriously difficult without a clean break in the data. This article develops and tests a framework for identifying when survey measures in autocratizing regimes produce false positives for regime support. The central theoretical contribution is a *sensitivity gradient* approach that exploits variation in the political costliness of different survey items. Under repressive conditions, items that evaluate coercive institutions (trust in police, trust in government) carry higher costs for honest critical response than items assessing abstract democratic values (democracy suitability, democratic commitment). If preference falsification drives observed attitude shifts, the magnitude of inflation should correlate with item sensitivity, generating a distinctive pattern of divergence across the survey instrument. This pattern---high-sensitivity items shifting in the regime-favorable direction while low-sensitivity items shift against the regime---serves as a diagnostic for measurement distortion that requires no experimental design and can be applied retrospectively to any survey fielded during a period of political change.

Hong Kong's post-2019 crisis provides unusual analytic leverage for testing this framework. Unlike the gradual erosion seen in Hungary or Poland, Hong Kong experienced an externally imposed shock that was both rapid and comprehensive. Crucially, Wave 5 of the Asian Barometer Survey (ABS) was fielded directly across this fracture: respondents interviewed during the 2019 pro-democracy protests answered the same instrument as those interviewed after nine months under the National Security Law (NSL). This unintended fieldwork disruption creates a natural quasi-experiment in which the cost of dissent shifted exogenously between sub-samples.

I document three findings. First, the sensitivity gradient predicts the observed "trust paradox": perceived democratic suitability collapsed in the post-NSL period ($d = -0.54$) while trust in the police---the primary agents of repression---surged by a comparable magnitude ($d \approx +0.49$), with the magnitude of trust inflation tracking each institution's coercive salience ($r = -0.85$ between pre-specified sensitivity ranking and observed effect size). Second, the canonical "critical citizens" correlation---whereby committed democrats express lower regime satisfaction [@Norris2011-zt]---reverses in post-NSL Hong Kong, the only such case among fifteen Asian polities, providing a diagnostic signal that standard survey relationships have broken down. Third, decomposing this reversal by respondents' conception of democracy reveals that it is driven entirely by procedural democrats---the subgroup with the highest cost of honest response---a pattern inconsistent with the "authoritarian notions of democracy" account [@Kirsch2019-vu] and consistent with strategic falsification among the regime's most likely critics. These findings suggest that during authoritarian consolidation, the metrics scholars rely on to diagnose institutional legitimacy may systematically invert, signaling rising support precisely when it is collapsing.

# The Validity Problem in Autocratizing Regimes

## Survey Validity Under Political Pressure

The concern that survey measures may not mean the same thing in authoritarian and democratic contexts is not new. @Kuran1995-up's foundational work on preference falsification demonstrated that citizens under repressive regimes systematically misrepresent their private beliefs in public, generating a gap between stated and genuine preferences that can persist at equilibrium. Empirical assessments of this phenomenon have proliferated in recent years. @Tannenberg2022-sc shows cross-nationally that respondents who believe the government commissioned a survey report systematically higher trust in autocracies but not in democracies, providing direct evidence that self-censorship inflates trust measures under authoritarian conditions. List experiments and endorsement experiments in China suggest that direct survey measures substantially overstate trust in sensitive institutions [@Nicholson2023-kt; @Blair2014-xl; @Bullock2011-kw]. @Jiang2016-hh exploit a political purge in China to show that responses to politically sensitive and insensitive survey items diverge following repressive events---an empirical strategy closely analogous to the present study. More recently, @Shamaileh2025-hh demonstrates that nonresponse rates alone are insufficient proxies for preference falsification, since respondents under repression shift toward the regime-preferred response rather than simply declining to answer.
...
All estimates incorporate ABS-provided post-stratification weights. Robustness checks include non-parametric Mann-Whitney $U$ tests, stratified percentile bootstrap with 5,000 iterations, Benjamini-Hochberg false discovery rate corrections, and Manski-style bounding exercises for both trust in police and trust in the national government (reported in the online appendix).
...
Third, existing findings in the backsliding literature that rely on post-repression survey data may warrant reinterpretation. Cross-national studies reporting elevated trust or satisfaction in autocratizing regimes, including work drawing on data from Myanmar post-2021, Turkey post-2016, and Russia post-2022, should consider whether the observed levels reflect genuine attitudes or the sensitivity gradient dynamics documented here. The framework is immediately applicable: sensitivity rankings can be constructed for trust items in any cross-national survey battery, and the correlation diagnostic requires only democratic commitment and satisfaction items that are standard across all major survey programs.

## Limitations

The within-wave comparison is a quasi-experiment, not a true experiment. Respondents were not randomly assigned to fieldwork periods, and the gap period complicates attribution to the NSL specifically. The analysis cannot determine the precise mix of preference falsification and compositional selection, nor cleanly separate the NSL's contribution from concurrent shocks. The sub-sample sizes ($N_{\text{Protest}} = 473$; $N_{\text{Post-NSL}} = 676$) are adequate for the moderate-to-large effects observed but limit the precision of subgroup analyses. Finally, the sensitivity gradient framework is tested on a single case of rapid, externally imposed autocratization; its applicability to gradual erosion from within, as in Hungary or Poland, remains to be established empirically.
