...
#
# Raw WVS .dta is in survey-data-prep repo.
# This script now uses the harmonized WVS parquet instead where possible.
# For raw WVS access, see survey-data-prep/data/wvs/raw/
...
wvs_raw_dir <- file.path(survey_data_prep, "data/wvs/raw/wave7")
wvs_path <- file.path(wvs_raw_dir, "WVS_Cross-National_Wave_7_stata_v6_0.dta")
...
if (!file.exists(wvs_path)) {
  ...
  if (length(alt_paths) > 0) {
    ...
    stop(
      ...
      "Place .dta file in survey-data-prep: data/wvs/raw/wave7/"
    )
  }
}
