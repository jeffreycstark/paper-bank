...
ref_elections <- tibble::tribble(
  ...
  "Japan", "W2", "House of Reps", "Sep 2005", "LDP (Koizumi)", "DPJ", "ABS codebook",
  "Japan", "W3", "House of Reps", "Aug 2009", "DPJ (Hatoyama)", "LDP", "ABS codebook",
  "Japan", "W4", "House of Reps", "Dec 2012", "LDP (Abe)", "DPJ", "ABS codebook",
  "Japan", "W6", "House of Reps", "Oct 2021", "LDP (Kishida)", "CDP", "ABS codebook",
  ...
  "Mongolia", "W2", "Parliamentary", "Jun 2004", "MPRP", "MDC", "ABS codebook",
  "Mongolia", "W3", "Parliamentary", "Jun 2008", "MPRP", "DP", "ABS codebook",
  "Mongolia", "W4", "Parliamentary", "Jun 2012", "DP", "MPP", "ABS codebook",
  "Philippines", "W2", "Presidential", "May 2004", "Arroyo (Lakas)", "Poe (KNP)", "ABS codebook",
  "Philippines", "W3", "Presidential", "May 2010", "Aquino III (LP)", "Estrada", "ABS codebook",
  "Philippines", "W4", "Midterm", "May 2013", "LP coalition", "UNA", "ABS codebook",
  "Philippines", "W6", "Presidential", "May 2022", "Marcos Jr. (PFP)", "Robredo (LP)", "ABS codebook",
  ...
  "Indonesia", "W2", "Presidential", "Sep 2004", "SBY (Democrat)", "Megawati (PDI-P)", "ABS codebook",
  "Indonesia", "W3", "Presidential", "Jul 2009", "SBY (Democrat)", "Megawati (PDI-P)", "ABS codebook",
  "Indonesia", "W4", "Presidential", "Jul 2014", "Jokowi (PDI-P)", "Prabowo (Gerindra)", "ABS codebook",
  "Indonesia", "W6", "Presidential", "Apr 2019", "Jokowi (PDI-P)", "Prabowo (Gerindra)", "ABS codebook",
  "Cambodia", "W3", "National Assembly", "Jul 2008", "CPP (Hun Sen)", "SRP", "ABS codebook",
  "Cambodia", "W4", "National Assembly", "Jul 2013", "CPP (Hun Sen)", "CNRP", "ABS codebook",
  "Cambodia", "W6", "National Assembly", "Jul 2018", "CPP (Hun Sen)", "CNRP dissolved", "ABS codebook",
  "Malaysia", "W2", "General election", "Mar 2004", "BN (Abdullah)", "PAS/DAP", "ABS codebook",
  "Malaysia", "W3", "General election", "Mar 2008", "BN (Abdullah)", "PR coalition", "ABS codebook",
  "Malaysia", "W4", "General election", "May 2013", "BN (Najib)", "PR (Anwar)", "ABS codebook",
  "Malaysia", "W6", "General election", "Nov 2022", "PH (Anwar)", "PN (Muhyiddin)", "ABS codebook",
  "Myanmar", "W4", "General election", "Nov 2015", "NLD (Aung San Suu Kyi)", "USDP", "ABS codebook",
  "Australia", "W4", "Federal election", "Sep 2013", "Coalition (Abbott)", "ALP (Rudd)", "ABS codebook"
)
...
if (knitr::is_latex_output()) {
  ref_elections %>%
    ...
    footnote(
      general = "Dashes indicate the country was not surveyed in that wave or, for Thailand W4, that no valid reference election existed. Source abbreviations: NEC = National Election Commission of Korea; CEC = Central Election Commission of Taiwan; ECT = Election Commission of Thailand.",
      general_title = "Note: ",
...
if (knitr::is_latex_output()) {
  verification %>%
    ...
    footnote(
      general = "Sources: Central Election Commission of Taiwan [@CEC2004; @CEC2008; @CEC2016]; National Election Commission of Korea [@NEC2008; @NEC2012; @NEC2020]; Election Commission of Thailand [@ECT2007; @ECT2019]; IFES Election Guide [@IFES_ElectionGuide].",
      general_title = "Note: ",
      footnote_as_chunk = TRUE,
      threeparttable = TRUE
    )
...
fairness <- read_csv(here("papers", "meaning-of-democracy", "analysis",
                          "revised", "results",
...
knitr::include_graphics(here("papers", "meaning-of-democracy", "analysis",
                             "revised", "results",
...
threeway <- read_csv(here("papers", "meaning-of-democracy", "analysis",
                          "revised", "results",
...
country_gaps <- read_csv(here("papers", "meaning-of-democracy", "analysis",
                              "revised", "results",
