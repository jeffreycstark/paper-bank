...
here::i_am("papers/meaning-of-democracy/analysis/revised/08_threeway_decomposition.qmd")

# Output directory
output_dir <- here("papers", "meaning-of-democracy", "analysis", "revised", "results")
...
vote_3way <- readRDS(here("papers", "meaning-of-democracy", "analysis",
                          "_archive_binary", "data", "vote_winner_opposition.rds"))

# Item metadata
item_meta <- readRDS(here("papers", "meaning-of-democracy", "analysis",
