...
# Cluster bootstrap SEs with success tracking
...
cat("════════════════════════════════════════════════════════════════\n")
cat("OVERALL: Both robustness checks strongly support the main findings.\n")
cat("The loser effect on procedural vs. substantive preferences is:\n")
cat("  • NOT driven by demographic confounders\n")
cat("  • NOT an artifact of the multinomial logit specification\n")
cat("════════════════════════════════════════════════════════════════\n")
```
