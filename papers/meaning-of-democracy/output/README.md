# Download figures from Claude's outputs
# Run this after the conversation to fetch the figures
...
# - fig_thailand_dual.png/pdf        - Thailand dual panel (loser effect + % winners)
# - fig_multicountry_trajectory.png/pdf - All countries with 3+ waves
# - fig_slope_change.png/pdf         - First-to-last wave slope chart
