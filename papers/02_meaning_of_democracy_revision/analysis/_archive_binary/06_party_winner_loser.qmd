...
here::i_am("papers/02_meaning_of_democracy_revision/analysis/06_party_winner_loser.qmd")
proj_root <- here::here()
```
...
vote_data <- readRDS("papers/02_meaning_of_democracy_revision/analysis/data/vote_winner_opposition.rds")
