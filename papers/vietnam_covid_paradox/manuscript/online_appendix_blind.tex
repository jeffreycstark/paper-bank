...
\caption*{
{\fontsize{20}{25}\selectfont  Trust \texttimes Infection Interaction Models\fontsize{7}{8}\selectfont } \\ 
{\fontsize{14}{17}\selectfont  Does Trust Moderate the Infection-Approval Relationship?\fontsize{7}{8}\selectfont }
} 
\fontsize{7.0pt}{8.0pt}\selectfont
\begin{tabular*}{\linewidth}{@{\extracolsep{\fill}}lrrrrrr}
\toprule
 & \multicolumn{2}{c}{Vietnam} & \multicolumn{2}{c}{Cambodia} & \multicolumn{2}{c}{Thailand} \\ 
\cmidrule(lr){2-3} \cmidrule(lr){4-5} \cmidrule(lr){6-7}
Variable & Vietnam \ensuremath{\beta} & Vietnam SE & Cambodia \ensuremath{\beta} & Cambodia SE & Thailand \ensuremath{\beta} & Thailand SE \\ 
\midrule\addlinespace[2.5pt]
Infection (Main) & 0.054 & 0.152 & -0.107 & 0.231 & 0.053 & 0.114 \\ 
Trust (Main) & 0.306*** & 0.037 & 0.467*** & 0.027 & 0.621*** & 0.036 \\ 
Infection \texttimes Trust & 0 & 0.043 & 0.034 & 0.072 & -0.046 & 0.049 \\ 
Institutional Trust & 0.14*** & 0.035 & 0.101** & 0.035 & 0.021 & 0.034 \\ 
Democracy Satisfaction & 0.115*** & 0.025 & 0.069** & 0.024 & 0.14*** & 0.030 \\ 
\bottomrule
\end{tabular*}
\begin{minipage}{\linewidth}
Note: *** p < 0.001, ** p < 0.01, * p < 0.05, \textdagger p < 0.10. HC3 robust standard errors.\\
\end{minipage}
...
\pandocbounded{\includegraphics[keepaspectratio]{online_appendix_blind_files/figure-pdf/fig-interaction-plot-1.pdf}}
...
\caption*{
{\fontsize{20}{25}\selectfont  Interview Timing Robustness Check\fontsize{12}{15}\selectfont } \\ 
{\fontsize{14}{17}\selectfont  F-Test for Month Effects on Approval\fontsize{12}{15}\selectfont }
} 
\fontsize{12.0pt}{14.0pt}\selectfont
\begin{tabular*}{\linewidth}{@{\extracolsep{\fill}}llrrl}
\toprule
country\_name & Country & Timing Effect p & \ensuremath{\Delta}R\texttwosuperior & Note \\ 
\midrule\addlinespace[2.5pt]
Cambodia & Cambodia & 0.643 & 0.004 & Not significant \\ 
Thailand & Thailand & 0.000 & 0.012 & Significant \\ 
Vietnam & Vietnam & 0.402 & 0.001 & Not significant \\ 
\bottomrule
\end{tabular*}
\begin{minipage}{\linewidth}
Note: Non-significant timing effects indicate approval is stable across interview periods within each country.\\
\end{minipage}
...
\pandocbounded{\includegraphics[keepaspectratio]{online_appendix_blind_files/figure-pdf/fig-evalue-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{online_appendix_blind_files/figure-pdf/fig-falsification-1.pdf}}

}

\caption{\label{fig-falsification}Falsification Test: Trust Predicts
COVID Outcomes More Strongly Than Non-COVID Outcomes}
...
\caption*{
{\fontsize{20}{25}\selectfont  Democracy Preference Distribution\fontsize{12}{15}\selectfont } \\ 
{\fontsize{14}{17}\selectfont  Q124: Which statement comes closest to your view?\fontsize{12}{15}\selectfont }
} 
\fontsize{12.0pt}{14.0pt}\selectfont
\begin{tabular*}{\linewidth}{@{\extracolsep{\fill}}crrrr}
\toprule
Country & N & Democracy Always (\%) & Authoritarian OK (\%) & Indifferent (\%) \\ 
\midrule\addlinespace[2.5pt]
Thailand & 1,018 & 70.8 & 19.4 & 9.8 \\ 
Vietnam & 1,104 & 70.6 & 13.0 & 16.4 \\ 
Cambodia & 1,076 & 66.5 & 16.0 & 17.5 \\ 
\bottomrule
\end{tabular*}
\begin{minipage}{\linewidth}
Note: N = respondents with valid q124 response. Majorities in all three countries---including Vietnam (70.6\%) and Cambodia (66.5\%)---express committed democratic preferences.\\
