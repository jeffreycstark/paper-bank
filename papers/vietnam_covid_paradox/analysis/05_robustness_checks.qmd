...
dir.create(here("papers/vietnam_covid_paradox/analysis/output/inline_stats"),
           recursive = TRUE, showWarnings = FALSE)
saveRDS(round(cor_trust_approval, 2),
        here("papers/vietnam_covid_paradox/analysis/output/inline_stats/cor_trust_approval.rds"))
...
dir.create(here("papers/vietnam_covid_paradox/analysis/results"),
           recursive = TRUE, showWarnings = FALSE)
saveRDS(stratified_results,
        here("papers/vietnam_covid_paradox/analysis/results/health_trauma_stratification.rds"))
...
saveRDS(round(all_vif_max, 2),
        here("papers/vietnam_covid_paradox/analysis/output/inline_stats/vif_max.rds"))
saveRDS(round(all_vif_min, 2),
        here("papers/vietnam_covid_paradox/analysis/output/inline_stats/vif_min.rds"))
...
create_crosstab <- function(country_data, country_name) {
  ...
  if(country_name == "Vietnam") {
    ...
    saveRDS(round(pct_trust_disapprove, 1),
            here("papers/vietnam_covid_paradox/analysis/output/inline_stats/pct_trust_disapprove.rds"))
  }
...
saveRDS(endogeneity_summary,
        here("papers/vietnam_covid_paradox/analysis/results/endogeneity_diagnostics.rds"))
  ...
  if(length(timing_rows) > 0) {
    ...
    if(length(timing_rows) > 0) {
      ...
      saveRDS(round(max_timing_p, 3),
              here("papers/vietnam_covid_paradox/analysis/output/inline_stats/vietnam_timing_p.rds"))

      # Also save R² change
      r2_change <- summary(model_with_timing)$r.squared - summary(model_no_timing)$r.squared
      saveRDS(round(r2_change, 3),
              here("papers/vietnam_covid_paradox/analysis/output/inline_stats/vietnam_timing_r2_change.rds"))
