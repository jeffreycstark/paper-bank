...
write_csv(completeness_vars, here("tables", "variable_completeness.csv"))
...
write_csv(completeness_country, here("tables", "completeness_by_country.csv"))
...
gtsave(complete_case_table, here("tables", "complete_case_summary.html"))
...
gtsave(paradox_table, here("tables", "table1_vietnam_paradox.html"))
...
ggsave(here("figures", "fig1_vietnam_paradox.png"), 
...
gtsave(descriptive_stats, here("tables", "table1_descriptive_stats.html"))
...
print(combined_dist)
ggsave(here("figures", "fig2_distributions.png"), combined_dist, 
...
# Save table
gtsave(reliability_table, here("tables", "table2_reliability.html"))
...
for (var in names(vars_to_plot)) {
  ...
  ggsave(
    here("figures", paste0("fig_dist_", var, ".png")),
...
ggsave(here("figures", "fig3_covid_approval.png"), width = 10, height = 6, dpi = 300)
...
covid_approval_data %>%
  ...
  gtsave(here("tables", "table2_covid_approval_cor.html"))
...
gtsave(economic_table, here("tables", "table_covid_impacts.html"))
...
ggsave(here("figures", "fig_economic_approval.png"), width = 10, height = 6, dpi = 300)
...
gtsave(economic_cor_table, here("tables", "table_economic_approval_cor.html"))
...
ggsave(here("figures", "fig_impact_comparison.png"), width = 12, height = 5, dpi = 300)
...
gtsave(comparison_table, here("tables", "table_impact_comparison.html"))
...
ggsave(here("figures", "fig4_trust_approval.png"), width = 10, height = 6, dpi = 300)
...
trust_approval_data %>%
  ...
  fmt_number(columns = correlation, decimals = 3) %>%
  gtsave(here("tables", "table3_trust_approval_cor.html"))
...
# Save table
gtsave(effect_size_table, here("tables", "table5_effect_sizes.html"))
...
# Save table
gtsave(bootstrap_table, here("tables", "table6_bootstrap_correlations.html"))
...
# Visualize
png(here("figures", "fig5_correlation_matrix.png"), width = 800, height = 800)
...
gtsave(correlation_matrix, here("tables", "table4_correlation_matrix.html"))
...
ggsave(here("figures", "fig6_emergency_powers.png"), width = 12, height = 6, dpi = 300)
...
write_csv(summary_stats, here("tables", "summary_statistics.csv"))
