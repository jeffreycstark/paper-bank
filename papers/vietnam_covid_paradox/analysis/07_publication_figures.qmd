...
dir.create(here("papers", "vietnam_covid_paradox", "analysis", "output", "figures"), showWarnings = FALSE)
dir.create(here("papers", "vietnam_covid_paradox", "analysis", "output", "figures", "publication"), showWarnings = FALSE)
dir.create(here("papers", "vietnam_covid_paradox", "analysis", "output", "figures", "presentation"), showWarnings = FALSE)
...
save_figure <- function(plot, filename, width = 10, height = 7, 
  ...
  output_dir <- here("papers", "vietnam_covid_paradox", "analysis", "output", "figures", type)
...
cat("\n\nFILE LOCATIONS:\n")
cat("  Publication figures:", here("papers", "vietnam_covid_paradox", "analysis", "output", "figures", "publication"), "\n")
cat("  Presentation slides:", here("papers", "vietnam_covid_paradox", "analysis", "output", "figures", "presentation"), "\n")
