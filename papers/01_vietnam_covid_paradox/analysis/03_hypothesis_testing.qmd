...
gtsave(h1_gt, here("papers", "01_vietnam_covid_paradox", "analysis", "output", "tables", "h1_covid_infection_effects.html"))
...
gtsave(h1c_coef_table, here("papers", "01_vietnam_covid_paradox", "analysis", "output", "tables", "h1c_interaction_model.html"))
...
ggsave(here("papers", "01_vietnam_covid_paradox", "analysis", "output", "figures", "h1c_interaction_plot.png"), h1c_plot, 
...
gtsave(h2a_gt, here("papers", "01_vietnam_covid_paradox", "analysis", "output", "tables", "h2a_trust_direct_effect.html"))
...
gtsave(h2b_gt, here("papers", "01_vietnam_covid_paradox", "analysis", "output", "tables", "h2b_mediation_analysis.html"))
```
...
ggsave(here("papers", "01_vietnam_covid_paradox", "analysis", "output", "figures", "h2c_trust_by_infection.png"), trust_plot,
       width = 10, height = 6, dpi = 300)
...
gtsave(h3a_gt, here("papers", "01_vietnam_covid_paradox", "analysis", "output", "tables", "h3a_democracy_effects.html"))
```
...
gtsave(h3b_gt, here("papers", "01_vietnam_covid_paradox", "analysis", "output", "tables", "h3b_authoritarianism_effects.html"))
```
...
gtsave(h4a_gt, here("papers", "01_vietnam_covid_paradox", "analysis", "output", "tables", "h4a_economic_impact.html"))
```
...
gtsave(h4b_gt, here("papers", "01_vietnam_covid_paradox", "analysis", "output", "tables", "h4b_trust_vs_economic.html"))
...
m1_table %>%
  as_gt() %>%
  gtsave(here("papers", "01_vietnam_covid_paradox", "analysis", "output", "tables", "model1_core.html"))
...
m2_table %>%
  as_gt() %>%
  gtsave(here("papers", "01_vietnam_covid_paradox", "analysis", "output", "tables", "model2_full.html"))
...
gtsave(comparison_gt, here("papers", "01_vietnam_covid_paradox", "analysis", "output", "tables", "model_comparison.html"))
```
...
gtsave(hypothesis_gt, here("papers", "01_vietnam_covid_paradox", "analysis", "output", "tables", "hypothesis_summary.html"))
