...
**Source**: `abs_harmonized.rds` from survey-data-prep — the fully harmonized dataset with haven labels already stripped.
...
```{r load-source}
# Load from survey-data-prep repo
source(file.path(project_root, "_data_config.R"))
abs_source <- readRDS(abs_harmonized_path)

cat("Source: abs_harmonized.rds (from survey-data-prep)\n")
