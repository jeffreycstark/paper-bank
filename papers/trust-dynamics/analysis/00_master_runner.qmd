...
library(here)
library(withr)
here::i_am("papers/trust-dynamics/analysis/00_master_runner.qmd")
...
withr::with_dir(
  here::here(),
  source(here("papers/trust-dynamics/analysis/data_prep_modules/00_run_all.R"))
)
```
...
quarto::quarto_render(
  here("papers/trust-dynamics/analysis/02_descriptive_analysis.qmd"),
  output_format = "html"
)
...
quarto::quarto_render(
  here("papers/trust-dynamics/analysis/03_hypothesis_testing.qmd"),
  output_format = "html"
)
...
quarto::quarto_render(
  here("papers/trust-dynamics/analysis/04_robustness_checks.qmd"),
  output_format = "html"
)
