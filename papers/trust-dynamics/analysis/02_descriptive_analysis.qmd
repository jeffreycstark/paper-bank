...
here::i_am("papers/trust-dynamics/analysis/02_descriptive_analysis.qmd")
set.seed(2025)
...
if (requireNamespace("naniar", quietly = TRUE)) {
  ...
  # Use sample for visualization to avoid memory issues with clustering
  naniar::vis_miss(analysis_data[, existing_vars], cluster = FALSE) +
...
ggsave(
  here("papers/trust-dynamics/analysis/figures/fig1_dv_by_regime.png"),
