...
\date{February 23, 2026 at 3:28 PM}
\begin{document}
\maketitle
\begin{abstract}
...
\begin{table}[!h]
\centering
\caption{\label{tab:tableA2}Subgroup Analysis by Urban/Rural Residence}
\centering
\resizebox{\ifdim\width>\linewidth\linewidth\else\width\fi}{!}{
...
\begin{table}[!h]
\centering
\caption{\label{tab:tableA2b}Subgroup Analysis by Age Group}
\centering
\resizebox{\ifdim\width>\linewidth\linewidth\else\width\fi}{!}{
\fontsize{8}{10}\selectfont
...
\begin{table}[!h]
\centering
\caption{\label{tab:tableA2c}Subgroup Analysis by Education Level}
\centering
\resizebox{\ifdim\width>\linewidth\linewidth\else\width\fi}{!}{
\fontsize{8}{10}\selectfont
\begin{tabular}[t]{llll}
...
\begin{table}[!h]
\centering
\caption{\label{tab:tableA3}Placebo Battery: Non-Political Variables by Wave}
\centering
\resizebox{\ifdim\width>\linewidth\linewidth\else\width\fi}{!}{
