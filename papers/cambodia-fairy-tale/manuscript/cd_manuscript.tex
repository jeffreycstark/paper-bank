...
\date{February 23, 2026 at 1:47 PM}
\begin{document}
\maketitle
\begin{abstract}
...
surveyed by the Asian Barometer (\textbf{Hu2023-ib?}). This was not a
...
one-party election. The four available waves nevertheless bracket the
...
analyses.\footnote{On ABS methodology and sampling design, see
  (\textbf{Chang2021-np?}). The ABS Technical Report for each wave
  provides country-level details on sampling frames, fieldwork dates,
  and response rates.}
...
understand what kind of silence it was.\footnote{Unless otherwise noted,
  ...
  Hughes (2010); Strangio (2014); and (\textbf{Un2013-ge?}).}
...
\begin{table}[!h]
\centering
\caption{\label{tab:table1}Wave 2 (2008) Baseline: Political Orientations in Cambodia}
\centering
...
\hspace{1em}Contacted elected official & 32.6\% (998)\\
\hspace{1em}Contacted civil servant & 31.8\% (999)\\
\hspace{1em}Contacted influential person & 43.0\% (997)\\
\hspace{1em}Signed petition & ---\\
\hspace{1em}Attended demonstration & ---\\
\hspace{1em}Contacted media & ---\\
\hspace{1em}Contacted community leader (mean, 1–5) & 1.53 (997)\\
...
\hspace{1em}Single-party rule & 1.79 (912)\\
\hspace{1em}Strongman rule & 1.60 (901)\\
\hspace{1em}Military rule & 2.19 (918)\\
\addlinespace[0.3em]
\multicolumn{2}{l}{\textbf{Democratic Expectations (0–10 scale)}}\\
\hspace{1em}Democratic future (10pt) & —\\
\hspace{1em}Democratic past (10pt) & —\\
\hspace{1em}Democratic present (10pt) & 6.72 (472)\\
\addlinespace[0.3em]
\multicolumn{2}{l}{\textbf{Corruption}}\\
\hspace{1em}Witnessed corruption (binary) & 0.28 (987)\\
\hspace{1em}National govt corruption (1–4) & 2.86 (776)\\
\hspace{1em}Local govt corruption (1–4) & 2.56 (940)\\
\addlinespace[0.3em]
\multicolumn{2}{l}{\textbf{Media \& Political Interest}}\\
\hspace{1em}Follows political news & —\\
\hspace{1em}Internet news (1–6) & —\\
\hspace{1em}Political interest & 2.56 (996)\\
\hspace{1em}Discusses politics & 1.65 (998)\\
\bottomrule
\end{tabular}
\begin{tablenotes}[para]
\item \textit{Note:} 
\item Wave 2 N = 1,000. Participation rows 1–6 report the percentage of respondents who ever engaged in each activity (gate question); valid N shown in parentheses. Rows 7–8 report means (community leader contact: 1–5 scale) or proportions (voted). '—' indicates item not fielded in this wave. Authoritarian preferences: 1 = very bad, 4 = very good. Democratic expectations: 0–10. Corruption witnessed: binary proportion. National/local corruption: 1 = not at all, 4 = extremely.
\end{tablenotes}
\end{threeparttable}
\end{table}
...
clarity.\footnote{Unless otherwise noted, the political chronology and
  electoral data in this section draw on Un (2013); Um (2014); Strangio
...
and Kem Sokha, resolved the coordination problem at a stroke.\footnote{Noren-Nilsson
  (2015); (\textbf{Un2013-ss?}).} The resulting party offered voters
...
held essentially steady at 55.9 percent, and demonstration attendance,
petition-signing, and civil servant contact all edged slightly upward
from their Wave 3 levels. Community leader contact averaged 2 on a
five-point frequency scale, essentially unchanged from 2012. The
``selective retreat'' of 2015 is not, in other words, a story written
primarily in the behavioral data. It is written instead in the
attitudinal record.

\begin{table}[!h]
\centering
\caption{\label{tab:table2}Selective Retreat, 2012--2015: Wave 3 to Wave 4 Comparison}
\centering
\fontsize{10}{12}\selectfont
\begin{threeparttable}
...
\hspace{1em}Contacted elected official & 4.1\% (1197) & 4.5\% (1182) & +0.4 pp\\
\hspace{1em}Contacted civil servant & 6.6\% (1199) & 11.0\% (1195) & +4.4 pp\\
\hspace{1em}Contacted influential person & 52.6\% (1196) & 55.9\% (1200) & +3.3 pp\\
\hspace{1em}Signed petition & 10.5\% (1200) & 14.5\% (1188) & +4.0 pp\\
\hspace{1em}Attended demonstration & 2.6\% (1200) & 4.5\% (1190) & +1.9 pp\\
\hspace{1em}Contacted media & 3.2\% (1198) & 3.4\% (1188) & +0.2 pp\\
\hspace{1em}Contacted community leader (mean, 1–5) & 1.90 (1196) & 2.00 (1200) & +0.10\\
\hspace{1em}Voted in last election & 0.79 (1196) & 0.83 (1195) & +0.04\\
\addlinespace[0.3em]
\multicolumn{4}{l}{\textbf{Authoritarian Preferences (1–4)}}\\
\hspace{1em}Expert rule & 1.58 (1189) & 1.66 (1188) & +0.08\\
\hspace{1em}Single-party rule & 1.97 (1189) & 1.78 (1193) & -0.19\\
\hspace{1em}Strongman rule & 1.73 (1194) & 1.76 (1167) & +0.03\\
\hspace{1em}Military rule & 2.19 (1187) & 1.98 (1181) & -0.21\\
\addlinespace[0.3em]
\multicolumn{4}{l}{\textbf{Democratic Expectations (0–10)}}\\
\hspace{1em}Democratic future (10pt) & 9.58 (910) & 7.72 (552) & -1.86\\
\hspace{1em}Democratic past (10pt) & 3.97 (951) & 3.87 (938) & -0.10\\
\hspace{1em}Democratic present (10pt) & 5.85 (738) & 5.06 (760) & -0.79\\
\addlinespace[0.3em]
\multicolumn{4}{l}{\textbf{Corruption}}\\
\hspace{1em}Witnessed corruption (binary) & 0.49 (1194) & 0.63 (1114) & +0.14\\
\hspace{1em}National govt corruption (1–4) & 2.67 (1098) & 2.90 (1125) & +0.23\\
\hspace{1em}Local govt corruption (1–4) & 2.47 (1183) & 2.56 (1184) & +0.09\\
\addlinespace[0.3em]
\multicolumn{4}{l}{\textbf{Media \& Political Interest}}\\
\hspace{1em}Follows political news & 3.07 (1199) & 2.86 (1200) & -0.21\\
\hspace{1em}Internet news (1–6) & 1.22 (1199) & 1.82 (1200) & +0.60\\
\hspace{1em}Political interest & 2.57 (1198) & 2.29 (1198) & -0.28\\
\hspace{1em}Discusses politics & 1.45 (1198) & 1.47 (1198) & +0.02\\
\bottomrule
\end{tabular}
\begin{tablenotes}[para]
\item \textit{Note:} 
\item W3 N = 1,200; W4 N = 1,200. Participation rows 1–6 report percentages (gate question); valid N shown in parentheses. $\Delta$ for participation rows is in percentage points (pp); for other rows, in scale units. '—' indicates item not fielded. Internet news harmonized to 1–6 frequency scale (1 = never, 6 = daily or more).
\end{tablenotes}
\end{threeparttable}
\end{table}
...
representing the steepest single-item decline in the dataset. Community
leader contact fell to a mean of 1.39 on the frequency scale, and
political discussion dropped to 1.26 on a four-point scale---a
...
\begin{table}[!h]
\centering
\caption{\label{tab:table3}Four-Wave Trajectory of Political Orientations in Cambodia, 2008--2021}
\centering
...
\hspace{1em}Contacted elected official & 32.6\% (998) & 4.1\% (1197) & 4.5\% (1182) & \textbf{13.3\% (1119)} & +9.2 pp\\
\hspace{1em}Contacted civil servant & 31.8\% (999) & 6.6\% (1199) & 11.0\% (1195) & \textbf{37.2\% (1138)} & +30.6 pp\\
\hspace{1em}Contacted influential person & 43.0\% (997) & 52.6\% (1196) & 55.9\% (1200) & \textbf{23.3\% (1137)} & -29.3 pp\\
\hspace{1em}Signed petition & --- & 10.5\% (1200) & 14.5\% (1188) & \textbf{30.5\% (1110)} & +20.0 pp\\
\hspace{1em}Attended demonstration & --- & 2.6\% (1200) & 4.5\% (1190) & \textbf{3.3\% (1062)} & +0.7 pp\\
\hspace{1em}Contacted media & --- & 3.2\% (1198) & 3.4\% (1188) & \textbf{12.2\% (1119)} & +9.0 pp\\
\hspace{1em}Contacted community leader (mean, 1–5) & 1.53 (997) & 1.90 (1196) & 2.00 (1200) & \textbf{1.39 (1137)} & -0.51\\
\hspace{1em}Voted in last election & — & 0.79 (1196) & 0.83 (1195) & \textbf{0.88 (1196)} & +0.09\\
\addlinespace[0.3em]
\multicolumn{6}{l}{\textbf{Authoritarian Preferences (1–4: very bad to very good)}}\\
\hspace{1em}Expert rule & — & 1.58 (1189) & 1.66 (1188) & \textbf{2.11 (1091)} & +0.53\\
\hspace{1em}Single-party rule & 1.79 (912) & 1.97 (1189) & 1.78 (1193) & \textbf{2.21 (1110)} & +0.24\\
\hspace{1em}Strongman rule & 1.60 (901) & 1.73 (1194) & 1.76 (1167) & \textbf{2.17 (1094)} & +0.44\\
\hspace{1em}Military rule & 2.19 (918) & 2.19 (1187) & 1.98 (1181) & \textbf{2.21 (1069)} & +0.02\\
\addlinespace[0.3em]
\multicolumn{6}{l}{\textbf{Democratic Expectations (0–10 scale)}}\\
\hspace{1em}Democratic future (10pt) & — & 9.58 (910) & 7.72 (552) & \textbf{6.67 (458)} & -2.91\\
\hspace{1em}Democratic past (10pt) & — & 3.97 (951) & 3.87 (938) & \textbf{4.78 (859)} & +0.81\\
\hspace{1em}Democratic present (10pt) & 6.72 (472) & 5.85 (738) & 5.06 (760) & \textbf{5.77 (714)} & -0.08\\
\addlinespace[0.3em]
\multicolumn{6}{l}{\textbf{Corruption}}\\
\hspace{1em}Witnessed corruption (binary) & 0.28 (987) & 0.49 (1194) & 0.63 (1114) & \textbf{0.15 (1175)} & -0.34\\
\hspace{1em}National govt corruption (1–4) & 2.86 (776) & 2.67 (1098) & 2.90 (1125) & \textbf{2.33 (1022)} & -0.34\\
\hspace{1em}Local govt corruption (1–4) & 2.56 (940) & 2.47 (1183) & 2.56 (1184) & \textbf{2.36 (980)} & -0.11\\
\addlinespace[0.3em]
\multicolumn{6}{l}{\textbf{Media \& Political Interest}}\\
\hspace{1em}Follows political news & — & 3.07 (1199) & 2.86 (1200) & \textbf{2.04 (1187)} & -1.03\\
\hspace{1em}Internet news (1–6) & — & 1.22 (1199) & 1.82 (1200) & \textbf{4.66 (1218)} & +3.44\\
\hspace{1em}Political interest & 2.56 (996) & 2.57 (1198) & 2.29 (1198) & \textbf{2.06 (1205)} & -0.51\\
\hspace{1em}Discusses politics & 1.65 (998) & 1.45 (1198) & 1.47 (1198) & \textbf{1.26 (1214)} & -0.19\\
\bottomrule
\end{tabular}
\begin{tablenotes}[para]
\item \textit{Note:} 
\item N per wave: W2 = 1,000; W3 = 1,200; W4 = 1,200; W6 = 1,242. Rows 1–6 (Political Participation) report the percentage of respondents who ever engaged in each activity (gate proportion), with per-cell valid N in parentheses; $\Delta$ for these rows is in percentage points. Rows 7–8 and all remaining rows report unweighted wave means with per-cell valid N in parentheses; $\Delta$ is the arithmetic difference. '---' indicates variable not fielded in that wave. $\Delta$ W3$\rightarrow$W6 = W6 value minus W3 value (peak-to-trough change). W6 column in bold marks the endpoint of the trajectory. Voted last election and corruption witnessed are binary proportions.
\end{tablenotes}
\end{threeparttable}}
\end{table}
...
economic change (3.10, 3.04, 3.27)---show no systematic decline across
...
intensified authoritarianism.\footnote{On the cross-national effects of
  COVID-19 on generalized trust, see (\textbf{Aassve2021-bk?}).}
However, the fact that this is the only non-political item showing a
substantial decline---while national pride, family economic assessment,
and perceived economic change all remain stable---suggests a localized
...
dramatic scale of the decline---from 49 percent to 15 percent---is far
...
those least engaged with politics. The preceding section on alternative
mechanisms has addressed the pandemic, generational, and
preference-falsification concerns in detail; the conclusion here is that
these factors may amplify specific estimates but cannot account for the
overall pattern. Finally, any single-country study faces the inherent
limitation of generalizability: the mechanisms identified here may be
specific to Cambodia's particular configuration of post-conflict
politics, dominant-party rule, and opposition dynamics.
...
Un, Kheang. (2013). {{Cambodia in 2012}: Towards developmental
...
\caption{\label{tab:tableA1}Cross-Wave Comparability of Survey Items}\\
\toprule
Variable & W2 (2008) & W3 (2012) & W4 (2015) & W6 (2021) & Status\\
\midrule
\endfirsthead
\caption[]{Cross-Wave Comparability of Survey Items \textit{(continued)}}\\
\toprule
Variable & W2 (2008) & W3 (2012) & W4 (2015) & W6 (2021) & Status\\
\midrule
\endhead
