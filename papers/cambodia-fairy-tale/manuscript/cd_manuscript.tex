...
\date{February 23, 2026 at 11:03 AM}
\begin{document}
\maketitle
\begin{abstract}
...
understand what kind of silence it was.\footnote{Unless otherwise noted,
  ...
  Hughes (2010); Strangio (2014); and Un (2013a).}
...
quiet.\footnote{Unless otherwise noted, the following scale conventions
  apply throughout: political participation items are measured on a 1--5
  scale (1 = never, 5 = often); authoritarian governance preferences on
  a 1--4 scale (1 = very bad, 4 = very good); democratic assessments on
  a 1--10 scale; corruption perceptions on a 1--4 scale (1 = hardly
  anyone, 4 = almost everyone); and media and political interest items
  on a 1--4 scale (1 = none, 4 = a great deal). Internet news frequency
  is harmonized to a 1--6 scale (1 = never, 6 = daily or more) across
  waves with differing original response categories; see the dedicated
  footnote in the Wave 3 discussion for details. Witnessed corruption is
  reported as a binary proportion. Voter turnout is self-reported and
  expressed as a percentage.} Political participation measures hovered
at modest levels: contacting elected officials averaged 3.44 and
contacting civil servants registered at 3.43---neither disengaged nor
actively engaged, but somewhere in the unremarkable middle. Community
leader contact stood at 1.53, suggesting that local political networks,
while present, were not sites of intensive citizen activity.
...
after the Wave 3 survey captured such stratospheric optimism, confirmed
...
Cambodia National Rescue Party.\footnote{Unless otherwise noted, the
  political chronology in this section draws on Un et al. (2020);
...
{\centering \includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{../analysis/figures/fig1_trend_panels.pdf}

}

\caption{Political Orientations in Cambodia by Domain, 2008--2021. Wave
means for selected indicators across five thematic domains. Dashed
vertical line marks 2017 CNRP dissolution. Y-axes are free-scaled; each
panel uses its own metric range. Source: Asian Barometer Survey, Waves
2, 3, 4, 6.}
...
\bibitem[\citeproctext]{ref-Un2013-ge}
Un, Kheang. (2013a). {Beyond the Crossroads?} \emph{Asian Survey},
\emph{53}, 142--149. \url{https://doi.org/10.1525/as.2013.53.1.142}
...
Un, Kheang, Luo, Jing Jing, Professor of Political Science at Northern
Illinois University., \& affiliate of the School of International
Relations and the Center for Southeast Asian Studies, Xiamen University.
(2020). {Cambodia in 2019: Entrenching one-party rule and asserting
national sovereignty in the era of shifting global geopolitics}.
\emph{Southeast Asian Affairs}, \emph{SEAA20}, 119--136.
