...
\date{February 23, 2026 at 8:46 AM}
\begin{document}
\maketitle
\begin{abstract}
...
\midrule
\addlinespace[0.3em]
\multicolumn{3}{l}{\textbf{Political Participation (1–5: never to often)}}\\
\hspace{1em}Contacted elected official & 3.44 & 1000\\
\hspace{1em}Contacted civil servant & 3.43 & 1000\\
\hspace{1em}Contacted community leader & 1.53 & 1000\\
\hspace{1em}Voted in last election & — & —\\
\hspace{1em}Attended demonstration & — & —\\
\hspace{1em}Signed petition & — & —\\
\addlinespace[0.3em]
\multicolumn{3}{l}{\textbf{Authoritarian Preferences (1–4: very bad to very good)}}\\
\hspace{1em}Expert rule & — & —\\
\hspace{1em}Single-party rule & 1.79 & 1000\\
\hspace{1em}Strongman rule & 1.60 & 1000\\
\hspace{1em}Military rule & 2.19 & 1000\\
\addlinespace[0.3em]
\multicolumn{3}{l}{\textbf{Democratic Expectations (0–10 scale)}}\\
\hspace{1em}Democratic future (10pt) & — & —\\
\hspace{1em}Democratic past (10pt) & — & —\\
\hspace{1em}Democratic present (10pt) & 6.72 & 1000\\
\addlinespace[0.3em]
\multicolumn{3}{l}{\textbf{Corruption}}\\
\hspace{1em}Witnessed corruption (binary) & 0.28 & 1000\\
\hspace{1em}National govt corruption (1–4) & 2.86 & 1000\\
\hspace{1em}Local govt corruption (1–4) & 2.56 & 1000\\
\addlinespace[0.3em]
\multicolumn{3}{l}{\textbf{Media \& Political Interest}}\\
\hspace{1em}Follows political news & — & —\\
\hspace{1em}Internet news & — & —\\
\hspace{1em}Political interest & 2.56 & 1000\\
\hspace{1em}Discusses politics & 1.65 & 1000\\
\bottomrule
\end{tabular}
\begin{tablenotes}[para]
\item \textit{Note:} 
\item N = 1,000. Means shown for items fielded in Wave 2; '—' indicates variable not included in this wave. Corruption witnessed is a binary proportion. National and local government corruption rated 1 (not at all corrupt) to 4 (extremely corrupt).
\end{tablenotes}
\end{threeparttable}
\end{table}
...
\midrule
\addlinespace[0.3em]
\multicolumn{4}{l}{\textbf{Political Participation (1–5)}}\\
\hspace{1em}Contacted elected official & 4.31 & 3.08 & -1.23\\
\hspace{1em}Contacted civil servant & 4.33 & 3.19 & -1.14\\
\hspace{1em}Contacted community leader & 1.90 & 2.00 & +0.10\\
\hspace{1em}Voted in last election & 0.79 & 0.83 & +0.04\\
\hspace{1em}Attended demonstration & 4.48 & 3.07 & -1.41\\
\hspace{1em}Signed petition & 4.34 & 3.23 & -1.11\\
\addlinespace[0.3em]
\multicolumn{4}{l}{\textbf{Authoritarian Preferences (1–4)}}\\
\hspace{1em}Expert rule & 1.58 & 1.66 & +0.08\\
\hspace{1em}Single-party rule & 1.97 & 1.78 & -0.19\\
\hspace{1em}Strongman rule & 1.73 & 1.76 & +0.03\\
\hspace{1em}Military rule & 2.19 & 1.98 & -0.21\\
\addlinespace[0.3em]
\multicolumn{4}{l}{\textbf{Democratic Expectations (0–10)}}\\
\hspace{1em}Democratic future (10pt) & 9.58 & 7.72 & -1.86\\
\hspace{1em}Democratic past (10pt) & 3.97 & 3.87 & -0.10\\
\hspace{1em}Democratic present (10pt) & 5.85 & 5.06 & -0.80\\
\addlinespace[0.3em]
\multicolumn{4}{l}{\textbf{Corruption}}\\
\hspace{1em}Witnessed corruption (binary) & 0.49 & 0.63 & +0.13\\
\hspace{1em}National govt corruption (1-4) & 2.67 & 2.90 & +0.23\\
\hspace{1em}Local govt corruption (1-4) & 2.47 & 2.56 & +0.09\\
\addlinespace[0.3em]
\multicolumn{4}{l}{\textbf{Media \& Political Interest}}\\
\hspace{1em}Follows political news & 3.06 & 2.86 & -0.21\\
\hspace{1em}Internet news & 1.22 & 1.82 & +0.61\\
\hspace{1em}Political interest & 2.57 & 2.29 & -0.28\\
\hspace{1em}Discusses politics & 1.46 & 1.47 & +0.01\\
\bottomrule
\end{tabular}
\begin{tablenotes}[para]
\item \textit{Note:} 
\item N = 1,200 per wave. Cell entries are wave means. $\Delta$ = W4 mean minus W3 mean; negative values indicate decline. '—' indicates variable not fielded. Internet news values reflect harmonization to a common frequency scale; see manuscript footnote for scale details.
\end{tablenotes}
\end{threeparttable}
\end{table}
...
\midrule
\addlinespace[0.3em]
\multicolumn{6}{l}{\textbf{Political Participation (1–5: never to often)}}\\
\hspace{1em}Contacted elected official & 3.44 & 4.31 & 3.08 & \textbf{1.74} & -2.56\\
\hspace{1em}Contacted civil servant & 3.43 & 4.33 & 3.19 & \textbf{2.47} & -1.86\\
\hspace{1em}Contacted community leader & 1.53 & 1.90 & 2.00 & \textbf{1.39} & -0.52\\
\hspace{1em}Voted in last election & — & 0.79 & 0.83 & \textbf{0.88} & +0.09\\
\hspace{1em}Attended demonstration & — & 4.48 & 3.07 & \textbf{1.29} & -3.20\\
\hspace{1em}Signed petition & — & 4.34 & 3.23 & \textbf{2.13} & -2.21\\
\addlinespace[0.3em]
\multicolumn{6}{l}{\textbf{Authoritarian Preferences (1–4: very bad to very good)}}\\
\hspace{1em}Expert rule & — & 1.58 & 1.66 & \textbf{2.11} & +0.53\\
\hspace{1em}Single-party rule & 1.79 & 1.97 & 1.78 & \textbf{2.21} & +0.24\\
\hspace{1em}Strongman rule & 1.60 & 1.73 & 1.76 & \textbf{2.17} & +0.45\\
\hspace{1em}Military rule & 2.19 & 2.19 & 1.98 & \textbf{2.21} & +0.02\\
\addlinespace[0.3em]
\multicolumn{6}{l}{\textbf{Democratic Expectations (0–10 scale)}}\\
\hspace{1em}Democratic future (10pt) & — & 9.58 & 7.72 & \textbf{6.67} & -2.91\\
\hspace{1em}Democratic past (10pt) & — & 3.97 & 3.87 & \textbf{4.79} & +0.82\\
\hspace{1em}Democratic present (10pt) & 6.72 & 5.85 & 5.06 & \textbf{5.78} & -0.08\\
\addlinespace[0.3em]
\multicolumn{6}{l}{\textbf{Corruption}}\\
\hspace{1em}Witnessed corruption (binary) & 0.28 & 0.49 & 0.63 & \textbf{0.15} & -0.34\\
\hspace{1em}National govt corruption (1–4) & 2.86 & 2.67 & 2.90 & \textbf{2.33} & -0.34\\
\hspace{1em}Local govt corruption (1–4) & 2.56 & 2.47 & 2.56 & \textbf{2.36} & -0.11\\
\addlinespace[0.3em]
\multicolumn{6}{l}{\textbf{Media \& Political Interest}}\\
\hspace{1em}Follows political news & — & 3.06 & 2.86 & \textbf{2.04} & -1.03\\
\hspace{1em}Internet news & — & 5.79 & 2.17 & \textbf{2.17} & -3.61\\
\hspace{1em}Political interest & 2.56 & 2.57 & 2.29 & \textbf{2.06} & -0.51\\
\hspace{1em}Discusses politics & 1.65 & 1.46 & 1.47 & \textbf{1.26} & -0.20\\
\bottomrule
\end{tabular}
\begin{tablenotes}[para]
\item \textit{Note:} 
\item N per wave: W2 = 1,000; W3 = 1,200; W4 = 1,200; W6 = 1,242. Cell entries are unweighted wave means. '—' indicates variable not fielded in that wave. $\Delta$ W3$\rightarrow$W6 = W6 mean minus W3 mean (peak-to-trough change). W6 column in bold marks the endpoint of the trajectory. Voted last election is a binary proportion. Corruption witnessed is a binary proportion.
\end{tablenotes}
\end{threeparttable}
\end{table}
...
perceived official expectations.\footnote{On social desirability bias in
  ...
  survey reliability under electoral authoritarianism (Frye et al.,
  2016; Schedler \& Sarsfield, 2007).} The post-2017 Cambodian
environment, in which public criticism of the government carried
tangible legal consequences, represents precisely the conditions under
which such bias would be expected to intensify. The two
...
point considerably.\^{}{[}Strangio (2020) provides the most
comprehensive account of Cambodia's positioning within China's Southeast
Asian strategy. On the divergent China perception trajectories across
ASEAN, the ABS cross-national data offer direct comparative evidence.
