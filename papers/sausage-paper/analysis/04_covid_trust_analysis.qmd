...
here::i_am("papers/sausage-paper/analysis/04_covid_trust_analysis.qmd")
set.seed(2025)
...
```{r load-abs}
abs_full <- readRDS(here("papers/sausage-paper/analysis/sausage_analysis.rds"))
...
abs_full <- readRDS(here("papers/sausage-paper/analysis/sausage_analysis_full.rds"))
